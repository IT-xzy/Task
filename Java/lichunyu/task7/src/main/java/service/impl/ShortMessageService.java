...
public class ShortMessageService {
    ...
    public  SendSmsResponse sendSms(String phoneNumber) throws ClientException {
        ...
        IClientProfile profile = DefaultProfile.getProfile("cn-hangzhou",shortMessage.getAccessKeyId(), shortMessage.getAccessKeySecret());
        DefaultProfile.addEndpoint("cn-hangzhou", "cn-hangzhou", shortMessage.getProduct(), shortMessage.getDomain());
        ...
        //必填:短信签名-可在短信控制台中找到
        request.setSignName(shortMessage.getSignName());
