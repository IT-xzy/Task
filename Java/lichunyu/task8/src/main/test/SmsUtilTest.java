...
public class SmsUtilTest {
    ...
    public void sendSms() throws ClientException, InterruptedException {
        ...
        //发送短信
        SendSmsResponse sendSmsResponse= smsUtil.sendSms(phoneNumber,verifiedCode);
        ...
        if(sendSmsResponse.getCode() != null && sendSmsResponse.getCode().equals("OK")) {
            QuerySendDetailsResponse querySendDetailsResponse = smsUtil.querySendDetails(phoneNumber,verifiedCode);
