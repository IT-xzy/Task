...
//        byte[] b = serializableUtilForRedis.enSerializable(students);
        byte[] b = serializableUtilForRedis.enSerializable(students);
        System.out.println("******************序列化结果***********************");
        System.out.println(b);
        redis.save("students".getBytes(), b);
        byte[] c=  redis.get("students");
        System.out.println("++++++++++++++++++++++");
//        b=c.toString().getBytes();
//        System.out.println(c);
        System.out.println(c);
        students = (List<Student>) serializableUtilForRedis.deSerializable(c);
        System.out.println("********************反序列化结果*********************");
        for (int i=0;i<students.size();i++){
            System.out.println(students.get(i));
        }
