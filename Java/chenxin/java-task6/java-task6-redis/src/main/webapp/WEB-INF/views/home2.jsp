...
<tiles:insertDefinition name="defaultTemplate">
    <tiles:putAttribute name="body">
        <div class="body">
            <!--picture-->
            <div class="bg-img"><img src="${pageContext.request.contextPath}/img/背景图片2.png"></div>
            <main>
                ...
                <div class="col-lg-9 col-md-9 col-sm-9 row row1">
                    <div class="main-left-top">
                        <div style="float: left"><img class="tudouwang" src="${pageContext.request.contextPath}/img/土豆网.png"></div>
