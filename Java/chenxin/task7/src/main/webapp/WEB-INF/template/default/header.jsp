    ...
    <div class=" row2">
        ...
        <div class="col-md-6 col-lg-4">
            ...
            <div class="newbutton">
                ...
                <button class="row2-button2 row2-button2:hover" type="button"><a href="/home2" style="color:#fff !important;text-decoration: none;">职业</a></button>
                <button class="row2-button3 row2-button3:hover" type="button"><a href="/u/home3" style="color:#fff !important;text-decoration: none;">推荐</a></button>
                <button class="row2-button3 row2-button3:hover" type="button"><a href="/u/home4" style="color:#fff !important;text-decoration: none;">个人主页</a></button>
