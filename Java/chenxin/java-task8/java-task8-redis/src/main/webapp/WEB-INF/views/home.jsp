    ...
    <tiles:putAttribute name="body">
        ...
        <div>
            <style type="text/css">
                ...
                #test2{
                    background-image: url("/img/side-bar-new-year.png");
            ...
            <%--<img id="test" src="../../img/side-bar-new-year.png" alt="">--%>
            <div id="test2">
                <ul>
                    <!-- ngRepeat: li in vm.contentSidebar -->
                    <li >
                        <%--<i class="fa fa-gift" ng-class="li.author"></i>--%>
                        <a href="http://www.jnshu.com/daily/17743?uid=3576" class="ng-binding">免费试学</a>
                    </li><!-- end ngRepeat: li in vm.contentSidebar -->
                    <li ng-repeat="li in vm.contentSidebar" class="ng-scope">
                        <a href="/u/signin" class="ng-binding">上海报名</a>
                    </li>
        ...
        <div class="body">
            ...
            <div id="frame">
                ...
                <div id="photos" class="play">
                    <img src="${pageContext.request.contextPath}/img/首页背景.png">
                    <img src="${pageContext.request.contextPath}/img/首页背景.png">
                    <img src="${pageContext.request.contextPath}/img/首页背景.png">
                </div>
            </div>
                        ...
                        <div class="col-md-12 col-lg-12">
                            <div class="row row-top">
                                <div class="col-lg-3 col-md-4 col-sm-3">
                                    <div class="row4-div1"><img src="${pageContext.request.contextPath}/img/rocket.png" class="row4-rocket"></div>
                                    <div class="row4-gaoxiao"><b>高效</b></div>
                                    <div class=" row4-1">将五到七年的成长时间，缩短到一年到三年。</div>
                                </div>
                                <div class="col-lg-3 col-md-4 col-sm-3">
                                    <div class="row4-div1"><img src="${pageContext.request.contextPath}/img/archive.png" class="row4-rocket"></div>
                                    <div class="row4-gaoxiao"><b>规范</b></div>
                                    <div class="row4-1">标准的实战教程，不会走弯路</div>
                                </div>
                                <div class="col-lg-3 col-md-4 col-sm-3">
                                    <div class="row4-div1"><img src="${pageContext.request.contextPath}/img/shape253.png" class="row4-rocket"></div>
                                ...
                                <div class="col-lg-3 col-md-6 col-sm-3">
                                    <div class="man-number0">
                                        <div class="man-number1"><img src="${pageContext.request.contextPath}/img/右边小人.png">12400</div>
                    ...
                    <div class="row row6">
                        ...
                        <div class=" col-lg-3 col-md-4 col-sm-4">
                            <div class="how-to-learn">
                                ...
                                <div class="row7-img"><img src="${pageContext.request.contextPath}/img/箭头.png"></div>
                            </div>
                        </div>
                        <div class="col-lg-3 col-lg-offset-0 col-md-4 col-sm-4 col-sm-offset-2 col-md-offset-2">
                            <div class="how-to-learn">
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-6 col-sm-6 row-9">
                            <button type="button" class="row9-button">
                                <img src="${pageContext.request.contextPath}/${list[0].image}" class="row9-button-img">
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6 row-9">
                            <button type="button" class="row9-button">
                                <img src="${pageContext.request.contextPath}/${list[3].image}" class="row9-button-img">
