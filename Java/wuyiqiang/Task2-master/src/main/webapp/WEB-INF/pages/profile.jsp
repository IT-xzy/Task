...
<h1>学生信息</h1>
    <c:if test="${student==null}" var="condition" scope="request">
        <form action="/task2/itschool/students" name="student" method="post">
    </c:if>

    <c:if test="${student!=null}" var="condition" scope="request">
        <form action="/task2/itschool/students/${student.id}" name="student" method="post">
    </c:if>
            ...
            <a href="/task2/itschool/students">返回</a>
