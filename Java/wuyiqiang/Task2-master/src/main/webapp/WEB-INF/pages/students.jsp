...
<body>
    <h1>学生信息</h1>
    <form action="/task2/itschool/students/student" method="get">
        <input name="id" type="text" placeholder="请输入查询ID" required="required">
        <input type="submit" value="查找">
    </form>
    <a href="/task2/itschool/students">****查看所有****</a>
    <a href="/task2/itschool/students/profile">****添加****</a>
    <a href="/task2/itschool/menu">****返回目录****</a>
    ...
    <table border="1" width="100%">
        ...
        <c:forEach items="${students}" var="student">
            <tr>
                ...
                <td>${student.hknow}</td>
                <td><a href="/task2/itschool/students/profile/${student.id}">更新</a></td>
