...
<c:if test="${!empty homepageList }">
            ...
            <%--<div class="col-xs-12 col-sm-3 text-center student-border media-student">--%>
                <%--<img src="${pageContext.request.contextPath}/images/portrait2.png" alt="">--%>
                <%--<strong>技术顾问：牛逼</strong>--%>
                <%--<p>啦啦</p>--%>
            <%--</div>--%>

            <%--<div class="col-xs-12 col-sm-3 text-center student-border media-student">--%>
                <%--<img src="${pageContext.request.contextPath}/images/portrait3.png" alt="">--%>
                <%--<strong>技术顾问：${item.student}</strong>--%>
                <%--<p>百度技术总监：${item.duty}</p>--%>
            <%--</div>--%>

            <%--<div class="col-xs-12 col-sm-3 text-center student-border media-student">--%>
                <%--<img src="${pageContext.request.contextPath}/images/portrait4.png" alt="">--%>
                <%--<strong>技术顾问：${item.student}</strong>--%>
                <%--<p>百度技术总监：${item.duty}</p>--%>
            <%--</div>--%>
    ...
    <div class="container">
        <div class="row text-center">
            ...
            <div class="cooperation-warp col-xs-12 col-sm-12">
                <div class="col-xs-12 col-sm-2 img-shadow media-img-shadow"><img src="images/qy1.png" alt="" class="img-responsive"></div>
                <div class="col-xs-12 col-sm-2 img-shadow media-img-shadow"><img src="images/qy2.png" alt="" class="img-responsive"></div>
                <div class="col-xs-12 col-sm-2 img-shadow media-img-shadow"><img src="images/qy3.png" alt="" class="img-responsive"></div>
                <div class="col-xs-12 col-sm-2 img-shadow media-img-shadow"><img src="images/qy4.png" alt="" class="img-responsive"></div>
                <div class="col-xs-12 col-sm-2 img-shadow media-img-shadow"><img src="images/qy5.png" alt="" class="img-responsive"></div>
            </div>
        </div>
    </div>
</div>
