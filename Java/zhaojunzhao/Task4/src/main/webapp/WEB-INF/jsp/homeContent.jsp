    ...
    <div class="main-c row">
        ...
        <ul class="list-unstyled text-center">
            <c:forEach var="expert" items="${expertList}">
                <li class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
                    <div>
                        <img src="${pageContext.request.contextPath}/imges/${expert.icon}">
                        <span>${expert.position}:${expert.name}</span>
                        <p class="text-left">${expert.intro}</p>
                        <p><ms:Date value="${expert.createAt}"/></p>
                    </div>
                </li>
            </c:forEach>
        </ul>
