...
public interface UserDao {
   ...
   /* // 根据用户名更新用户信息
    ...
    User  getUserPhone(String tel);
    User  getUserEmail(String email);

    User getUserNameAndPhone(@Param("name") String name,@Param("phone") String phone);

    User getUserNameAndEmail(@Param("name") String name,@Param("email") String email);

    List<User> getUserPhoneAndEmail(@Param("phone") String tel,@Param("email") String email);
