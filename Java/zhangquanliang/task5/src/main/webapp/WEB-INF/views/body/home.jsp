...
<div id="myCarousel" class="carousel slide">
    ...
    <div class="carousel-inner">
        <div class="item active">
            <img src="https://notetest.nos-eastchina1.126.net/static/img/html8.1.png" alt="First slide">
        </div>
        <div class="item">
            <img src="https://notetest.nos-eastchina1.126.net/static/img/html8.jpg" alt="Second slide">
        </div>
        <div class="item">
            <img src="https://notetest.nos-eastchina1.126.net/static/img/html8.3.png" alt="Third slide">
        </div>
    </div>
    <!-- 轮播（Carousel）导航 -->
