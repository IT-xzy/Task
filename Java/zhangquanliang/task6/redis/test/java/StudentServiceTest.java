...
public class StudentServiceTest {
    ...
    public void insertStudent() throws Exception {
        for(int i= 0;i<1000;i++) {
            ...
            student.setPosition(DataUtils.getPosition());
            student.setImg(DataUtils.getImg());
            student.setProfession(DataUtils.getProfession());
            student.setType(DataUtils.getType());
            student.setIntro(DataUtils.getIntro());
            student.setSalary(DataUtils.getSalary());
