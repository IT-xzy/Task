    ...
    <div class="container logo">
        ...
        <div class="img-amuse">
            ...
            <c:if test="${empty name}">
                <a class="btn btn-sm" href="${pageContext.request.contextPath}/login">登录</a>
                <a class="btn btn-sm" href="${pageContext.request.contextPath}/reg">注册</a>
            </c:if>

            <c:if test="${!empty name}">
               <%-- String userImg = ${pageContext.request.contextPath}/u/user/img/${name};--%>

                <a href="/u/user/${name}">
                    <img src="${img}" width="25px" height="25px" style="border-radius: 50%" />
                </a>
                <i style="color: #000000; font-size: x-small">${name}&nbsp;欢迎您！ </i>
