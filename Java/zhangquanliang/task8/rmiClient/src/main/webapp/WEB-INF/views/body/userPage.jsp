...
<div align="center" style="margin-top: 16px;margin-bottom: 16px;">
    <div id="view" >
        <a href="/home">返回首页</a>
        <table border="1" align="center"  style="border: 1px solid chartreuse;background:#dddddd;width:38%;height: 380px">
            <tr align="center">
                <th colspan="2">
                    个人信息展示
                </th>
            ...
            <tr align="center">
                <td>头像</td>
                <td><img border="0" src="${user.img}" alt="picture" width="108" height="108" class="pimg"></td>
            </tr>
            <tr align="center">
                <td colspan="2" >
    ...
    <div id="modify">
        <form action="/u/user/${user.name}" id="form1" method="post">
          <%--  <input type="hidden" name="_method" value="PUT">--%>
            ...
            <table border="1" align="center"  style="border: 1px solid chartreuse;background:#dddddd;width:38%;height: 380px " >
                ...
                <tr align="center">
                    ...
                    <td>
                        <br>
                        <input id="file" type="file" name="multipartFile" accept="image/jpeg" onchange="verificationPicFile(this)" />
                        <br>
                        <br>
