...
public interface UserRmiService {
    ...
    JsonResult upadate(User user,HttpServletRequest httpServletRequest);
    ...
    void logout();
    void profile(Long id, HttpServletResponse httpServletResponse, HttpServletRequest httpServletRequest);
    void service(HttpServletResponse httpServletResponse, HttpServletRequest httpServletRequest) throws ServletException, IOException;
}
