package com.jnshu.ssm.entities;
...
public class User implements Serializable {
        ...
        @Pattern(regexp = "^[0-9]{6,12}$",message = "请填写QQ，6-12位数字组合（后台校验）")
        private String qq;
...
//    Pattern表示自定义注解，regexp属性是正则表达式
        ...
        @Pattern(regexp ="(^[A-Z]{2,4}$)" ,message = "学习类型应为：QA、UI、PM、WEB、JAVA")
...
//        @NotNull
//        @Pattern(regexp = "^[0-9]{1,4}$",message = "请填写线上学号，1-4位数字")
