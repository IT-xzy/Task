...
<div class="carousel-main">
    ...
    <!--轮播图片-->
    <img class="carousel_img-1" src="../module/carousel/carousel-1.png">
    <img class="carousel_img-2" src="../module/carousel/carousel-2.jpeg">
    <img class="carousel_img-3" src="../module/carousel/carousel-3.jpg">
    <!--左右空心箭头-->
        ...
        <div class="row">
            <c:forEach items="${students}" var="s" varStatus="st">
                <div class="col-lg-3 col-md-6 col-sm-12">
                    <div class="show">
                        <img src="../img/css8/user1.png">
                        <div class="show_title">${s.name}</div>
