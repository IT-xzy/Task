...
public class PaperController {
    ...
    public String queryAllPaper(@RequestParam(value = "currentPage", defaultValue = "1", required = false) int currentPage, Model model) throws Exception {
    ...
    public String addPaper(Paper paper) throws Exception {
    ...
    public ModelAndView deleteUser(@PathVariable("paperId") long id) throws Exception {
    ...
    public String toUpdatePaper(Model model, @PathVariable("id") int id) throws Exception {
    ...
    public String queryPaper(Model model, @RequestParam("id") int paperId) throws Exception {
        logger.info("\n后端取到的id值："+paperId);
    ...
    public String queryAllPaper(Model model) throws Exception {
...
/*
    ...
    @RequestMapping(value = "/findPaperByName", method = RequestMethod.GET)
    public String findPaperByName(Model model,@PathVariable("name") String name) throws Exception {
        List<Paper> userList1 = paperService.findPaperByName();
        //logger.info("the students are::{}"+userList1.toString());
        model.addAttribute("userList1", userList1);
        logger.info("---模糊查询的结果集："+userList1+"---");
        return "findPaperByName";
