...
public class PaperController {
    ...
    public ModelAndView deleteUser(@PathVariable("paperId") int id) {
        ...
        logger.info("controller:是否删除论文记录成功" + A);
    ...
    //获取编辑页面
    @RequestMapping(value = "/toUpdatePaper/{paperId}", method = RequestMethod.GET)
    public String toUpdatePaper(Model model, @PathVariable("paperId") int paperId) {
