...
public class PaperController {
    ...
    // TODO: 2018/7/16 Json
    // TODO: 2018/7/16
    // TODO: 2018/7/16 Log4j  ok
    // TODO: 2018/7/16  True false 返回值
    // TODO: 2018/7/16 数据库基本数据类型不赋值时   默认值


    @RequestMapping(value = "/del/{paperId}", method = RequestMethod.DELETE)
    public ModelAndView deleteUser(@PathVariable("paperId") long id) {
        //logger.info("/del/{} POST");
        logger.info("controller:开始删除数据...");
        ModelAndView modelAndView = new ModelAndView();
        int A=paperService.deletePaperById(id);
