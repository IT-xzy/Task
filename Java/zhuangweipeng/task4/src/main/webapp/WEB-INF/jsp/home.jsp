...
<div class="main container">
    ...
    <div class="main-a row">
        ...
        <%--<p>${studynum}</p>--%>
            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3 text-center">
                <p>
                    <img src="${pageContext.request.contextPath}/imges/453254312.png"> <c:out value="${studynum}" default="无"/>
                    <br>
                    <span class="up-3">累计在线学习人数</span>
                </p>
                <p>
                    <img src="${pageContext.request.contextPath}/imges/453254312.png"><c:out value="${jobnum}" default="无"/><br>
    ...
    <div class="main-c row">
        ...
        <%--<p <img src="${user.imges}"></p>--%>
        <%--<p>${consultant}</p>--%>
        <%--&lt;%&ndash;<p>${imges}</p>&ndash;%&gt;--%>
        <%--<img src="${imges}">--%>
        <%--<p>${introduction}</p>--%>
        <ul class="list-unstyled text-center">
            <c:forEach var="limit" items="${limit}">
                ...
                <li class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
                    <div>
                        <img src="${limit.imges}">
                        <span>技术顾问:${limit.consultant}</span>
                        <p class="text-left">${limit.introduction}</p>
                    </div>
                </li>
            </c:forEach>
        </ul>
