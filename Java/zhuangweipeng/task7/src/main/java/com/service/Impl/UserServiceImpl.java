...
public class UserServiceImpl implements UserService {
    ...
    public User finUserByPhone(String phone) {
        User user = userMapper.findUserByName(phone);
        return user;
    }
    //判断邮箱是否已经注册
    @Override
    ...
    //添加头像
    @Override
    public Boolean updateUserByName(String name, String photo) {
        Boolean b=userMapper.updateUserByName(name,photo);
        return b;
    }
    ...
    //根据用户查询头像
    @Override
    public String findPhotoByName(String name) {
        String photo =userMapper.findPhotoByName(name);
        return photo;
    }
    ...
    public Boolean judgeUserExist(String name) {
        Boolean b = userMapper.judgeUserExist(name);
        return b;
    }
