...
import exception.PaperException;
...
public class PaperController {
    ...
    @Autowired
    private DistributeServer distributeServer;
    ...
    public String queryAllPaper(@RequestParam(value = "currentPage", defaultValue = "1", required = false) int currentPage, Model model) throws Exception {
        PaperService paperService= distributeServer.getPaperService();
    ...
    public ModelAndView deleteUser(@PathVariable("paperId") int id) throws Exception {
        PaperService paperService= distributeServer.getPaperService();
    ...
    public String updatePaper(Paper paper) throws Exception {
        PaperService paperService= distributeServer.getPaperService();
