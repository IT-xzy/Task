...
<div class="main container">
  ...
  <div class="main-a row">
    ...
    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3 text-center">
      <p>
        <img src="/images/453254312.png">${learnNum}<br>
        <span class="up-3">累计在线学习人数</span>
      </p>
      <p>
        <img src="/images/453254312.png">${worknum}<br>
  ...
  <div class="main-c row">
    ...
    <ul class="list-unstyled text-center">
    <#list ListMember as member>
      <li class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
        <div>
          <img src="/images/242424.png">
          <span>${member.title}:${member.name}</span>
          <p class="text-left">${member.introduce}</p>
        </div>
      </li>
    </#list>
    </ul>
