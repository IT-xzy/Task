...
<form action="/Student" method="post">
    ...
    <br>
        <br>
    id：<input name="id" value="${student.id}" type="text">
    ...
    职业：<input name="professional" value="${student.professional}" type="text">
    ...
    日报：<input name="daily_url" value="${student.daily_url}" type="text">
