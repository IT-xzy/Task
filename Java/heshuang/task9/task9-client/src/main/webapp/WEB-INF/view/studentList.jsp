    ...
    <table border="1" cellpadding="0" cellspacing="0" class="table">
        ...
        <c:forEach items="${requestScope.pagemsg.lists}" var="student">
            <tr>
                ...
                <td>${student.city}</td>
                <td><form action="/u/student/${student.id}" method="get">
                    <input type="submit" value="编辑">
                </form>
                </td>
                <td><form action="/u/student/${student.id}" method="post">
    ...
    <tr>
        <td class="td2">
            ...
            <c:if test="${requestScope.pagemsg.currPage !=1}">
                <a href="${pageContext.request.contextPath}/u/students?currentPage=1">首页</a>&nbsp;&nbsp;
                <a href="${pageContext.request.contextPath}/u/students?currentPage=${requestScope.pagemsg.currPage-1}">上一页</a>&nbsp;&nbsp;
            </c:if>

            <c:if test="${requestScope.pagemsg.currPage !=requestScope.pagemsg.totalPage}">
                <a href="${pageContext.request.contextPath}/u/students?currentPage=${requestScope.pagemsg.currPage+1}">下一页</a>&nbsp;&nbsp;
                <a href="${pageContext.request.contextPath}/u/students?currentPage=${requestScope.pagemsg.totalPage}">尾页</a>&nbsp;&nbsp;
            </c:if>
        </td>
    </tr>
</table>
