...
public class Student implements Serializable {
    ...
    public Student(long id, long create_at, String name, String qq, String professional, String start_time,
                   String university, Integer online_id, String daily_url, String oath,
                   String counselor, String city) {
        this.id = id;
