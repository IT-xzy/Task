...
<%@ taglib uri="/tags" prefix="zhh"%>
 ...
 <div style="width:500px;margin:0px auto;text-align:center">
	 <c:forEach items="${ss}" var="s" varStatus="st" begin="0" end="2">
		 <div style="float:left; width:100px;">
		 <span>姓名：</span><span>${s.name}   </span> <br><br>
			 <span>学校：</span> <span>${s.address}  </span><br><br>
			 <span>电话：</span> <span>${s.phone}  </span> <br><br>
		 </div>
	 </c:forEach>
 </div>
