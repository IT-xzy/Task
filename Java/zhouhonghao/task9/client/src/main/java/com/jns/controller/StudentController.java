...
import com.jns.utils.RmiService;
...
public class StudentController {
	...
	public StudentController() throws RemoteException, NotBoundException, MalformedURLException {
	}
	...
	public ModelAndView listStudent(@RequestParam(value = "currPage",defaultValue = "1",required = true) int currPage) {
		...
		//分页不用插件，根据页码，来搜索数据。
		//nocache方法
		System.out.println("数量："+studentService.total());
