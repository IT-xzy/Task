...
<main>
    <div class="container">
        <h4>
            ...
            &gt;
            <a href="/u/job"><strong>职业</strong></a>
        </h4>
        <nav>
            <span>方向：</span>
                    ...
                    <section>
                        ...
                        <table class="table table-bordered">
                            ...
                            <tr>
                                ...
                                <td>
                                    <span>难易程度</span>
                                    <c:forEach begin="1" end="${subject[i].diffculty_level}">
                                    <img src="/img/star.png" alt="star">
                                    </c:forEach>
                                </td>
                            </tr>
                            <tr>
                                <td><span>成长周期</span><span class="color-red">${subject[i].growth_cycle}</span><span>年</span></td>
                                <td><span>稀缺程度</span><span class="color-red">${subject[i].rareness}</span><span>家公司需要</span></td>
                            </tr>
                            <tr>
                                <td rowspan="3">薪资待遇</td>
                                <td><span>0-1年</span><span class="fl-right">${subject[i].salary_first}</span></td>
                            </tr>
                            <tr>
                                <td><span>1-3年</span><span class="fl-right">${subject[0].salary_second}</span></td>
                            </tr>
                            <tr>
                                <td><span>3-5年</span><span class="fl-right">${subject[i].salary_third}</span></td>
                            </tr>
