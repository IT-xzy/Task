...
public class TimerAspectHandel {
    ...
    */
    ...
    /**
     * 学员数据被删除或者更新，缓存中的数据就有问题了，得删除。必须是先更新后删除（或者更新缓存）
     */
    ...
    public void delMemcache() {
        jedisCache.delete("studentList");
        jedisCache.delete("superStudentList");
        jedisCache.delete("totalCount");
        jedisCache.delete("workCount");
