...
import com.fml.rmi.DistributeServer;
...
public class HomeController {
    ...
    public String homeView(Model model){
        StudentService studentService = distributeServer.getStudentService();
    ...
    public String vocationView(Model model){
        VocationService vocationService = distributeServer.getVocationService();
        StudentService studentService = distributeServer.getStudentService();
        /*各个课程的学习人数*/
