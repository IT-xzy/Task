            ...
            <div class="col-md-4 col-sm-6 col-xs-12 top-margin">
                <div class="warp-border">
                    ...
                    <div class="warp-class2">
                        ...
                        <div class="warp-class2-text">
                            <div class="iconfont text-padding text-border-left">稀缺程度:${list.degreeOfScarcity}</div>
                        </div>
                    </div>
                    <div class="warp-class2">
                        <div class="leftWarp">
                    ...
                    <div class="warp-class2">
                        <b class="text-b">有<span class="iconfont-color">${list.inTheNumberOfStudents}</span>人在学</b>
                    </div>
                    <div class="warp-class2">
                        <p class="text-p">提示:在你学习之前应该掌握<span class="iconfont-color">${list.promptStatement}</span>基础</p>
                    </div>
                </div>
            </div>
        </c:forEach>
