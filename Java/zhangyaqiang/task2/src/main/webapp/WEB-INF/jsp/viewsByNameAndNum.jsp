        ...
        <tr>
            <th colspan="13">
                ...
                <c:if test="${page.currPage!=1}">
                    <a href="/Students/${name}/${number}?currPage=1">首页</a>
                    <a href="/Students/${name}/${number}?currPage=${page.currPage-1}">上一页</a>
                </c:if>
                <c:if test="${page.currPage!=page.totalPage}">
                    <a href="/Students/${name}/${number}?currPage=${page.currPage+1}">下一页</a>
                    <a href="/Students/${name}/${number}?currPage=${page.totalPage}">末页</a>
                </c:if>
            </th>
        </tr>
    </table>
