                    ...
                    <td style="font-size: large" colspan="2">
                        <ul id="content">
                            ...
                            <li class="action" id="content1">
                                ...
                                <div id="usernameNotNull" style="display: none;color: red;font-size: medium" align="center">账号不能为空</div>
                            </li>
                            <li id="content2">
                                &ensp;&nbsp;手机号&ensp;&ensp;&ensp;
                                <input type="text" name="telephone" id="telephone">
                                <div id="telephoneNotNull" style="display: none;color: red;font-size: medium" align="center">手机号不能为空</div>
                            </li>
                            <li id="content3">
                                &ensp;&ensp;邮箱&ensp;&ensp;&ensp;&ensp;&nbsp;
                                <input type="text" name="email" id="email">
                                <div id="emailNotNull" style="display: none;color: red;font-size: medium" align="center">邮箱不能为空</div>
                            </li>
                        </ul>
                    </td>
                </tr>
