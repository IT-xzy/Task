...
<div align="center">
    ...
    <form action="/user" method="post" onkeydown="if(event.keyCode==13)return false;" id="form1" >
        <table style="border: 1px solid chartreuse;background:#dddddd">
                ...
                <td colspan="2" style="font-size: large">
                    <ul id="content">
                        ...
                        <li class="action" id="content1">
                            ...
                            <button type="button" style="width: 90px" id="sendMsgByTel" disabled="disabled">发送验证码</button>
                        </li>
                        <li id="content2">
                            &thinsp;&thinsp;&ensp;&ensp;&ensp;&nbsp;邮箱&emsp;&ensp;&ensp;&ensp;
                            <input type="text" name="email" id="email">
                            <button type="button" style="width: 90px" id="sendMsgByEmail" disabled="disabled">发送验证码</button>
                        </li>
                    </ul>
                    <div id="telephoneNotNull" style="display: none;color: red;font-size:medium" align="center">请输入正确的手机号</div>
                    <div id="telephoneUnique" style="display: none;color: red;font-size:medium" align="center">该手机号已经注册</div>
                    <div id="emailNotNull" style="display: none;color: red;font-size:medium" align="center">请输入正确格式的邮箱</div>
            ...
            <tr align="center"><td colspan="2"><input type="button" style="height: 200%;width: 35%" id="button" value="提交">
                <div id="buttonDiv" style="display: none;color: red">请填写所有的注册信息</div></td></tr>
            <tr align="center">
                <td colspan="2">
