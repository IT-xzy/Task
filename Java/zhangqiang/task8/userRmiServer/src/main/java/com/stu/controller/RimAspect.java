...
public class RimAspect {
    ...
    @Around(value = "execution(* com.stu.service.impl.UserServiceImpl.*(..))")
    public Object rmiServerRunlisner(ProceedingJoinPoint joinPoint) throws Throwable {
        ...
        logger.info("UserServer RMI服务 开始执行远程方法调用,远程服务hostName："+ System.getProperty("java.rmi.server.hostname") + ", 调用方法：" + mam.getMethodName());
