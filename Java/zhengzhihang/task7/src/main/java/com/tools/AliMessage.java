...
public class AliMessage {
    private static org.apache.log4j.Logger logger= org.apache.log4j.Logger.getLogger(AliMessage.class);
    ...
    private  String signame;//myname
    private  String templateCode;//"SMS_141945278"
    ...
    public  SendSmsResponse sendSms(String phoneNumber, String code) throws ClientException {
        ...
        //创建一个用于存储验证码的String
//        StringBuilder code=new StringBuilder();//用工具类入参就行
        int random;
        //可自助调整超时时间
...
//        //发短信
//        SendSmsResponse response = sendSms("13824429757","123");
