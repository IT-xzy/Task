    ...
    <div class="main container">
            ...
            <div class="main-a row">
                ...
                <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3 text-center">
                    <p>
                        <img src="../../imges/453254312.png">${accountTrainees}<br>
                        <span class="up-3">累计在线学习人数</span>
                    </p>
                    <p>
                        <img src="../../imges/453254312.png">${countWore}<br>
            ...
            <div class="main-c row">
                ...
                <ul class="list-unstyled text-center">
                    ...
                    <li class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
                        <div>
                            <img src="../../imges/${l.pic}">
                            <span>技术顾问:${l.name}</span>
                            <p class="text-left">公司 : ${l.company} 薪水 : ${l.salary} </p>
                            <p class="text-left">描述 : ${l.description}  </p>
                        </div>
                    </li>
                    </c:forEach>
                </ul>
