package task8_service.controlller;
...
import task8_service.service.UserService;
import task8_service.serviceChange.ServiceChange;
import task8_service.util.TokenUtils;
...
public class loginController {
    ...
    public String login(HttpServletRequest request, HttpServletResponse response) throws UnsupportedEncodingException {
        UserService userService=(UserService) ServiceChange.getObjService("userService");
