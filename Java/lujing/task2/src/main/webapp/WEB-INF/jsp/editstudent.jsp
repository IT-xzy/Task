...
<body>
	<form id="itemForm"
		action="${pageContext.request.contextPath }/student/${student.id}" method="">
		...
		<table border=1 align='center'>
			...
			<tr>
				<td>createAt(使用自定义标签转换)</td>
				<td><input type="date" name="createAt" value="<md:date  value="${student.createAt }" pattern="yyyy-MM-dd"/>" /></td>
			</tr>
