...
<%@ taglib uri="/WEB-INF/mytag.tld" prefix="leon" %>
...
<div class="main container">
    ...
    <div class="main-a row">
        ...
        <c:forEach var="user" begin="1" end="1" items="${user}">
            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3 text-center">
                <p>
                    <img src="/imges/453254312.png"> <c:out value="${user.studynum}" default="无"/>
                    <br>
                    <span class="up-3">累计在线学习人数</span>
                </p>
                <p>
                    <img src="/imges/453254312.png"><c:out value="${user.jobnum}" default="无"/><br>
    ...
    <div class="main-c row">
        ...
        <ul class="list-unstyled text-center">
            <c:forEach var="user" begin="1" end="${size}" items="${user}">

                <li class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
                    <div>
                        <img src="${user.imges}">
                        <span>技术顾问:${user.consultant}</span>
