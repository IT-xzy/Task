        ...
        function buttclick() {
            ...
            if (count == 60) {//只有计数等于60时才会调用ajax
                $.ajax({
                    ...
                    data: {emailNum: emailNum.value},//json格式对象
                    timeout: 5000,//设置超时时间
...
<div class="login_m">
    <div class="login_logo"><h1>邮箱验证界面</h1></div>
    ${返回通知}
    <div class="login_boder">
        <div class="login_padding">
            <form action="/register/email" method="post">
                <h1>账号：</h1>  <input type="text" id="account" name="account" class="txt_input txt_input2"/><br>
                <h1>密码：</h1> <input type="password" name="password" class="txt_input txt_input2"/><br>
                <h1>邮箱：</h1>  <input id="email" type="text" name="email" class="txt_input txt_input2"/><br>
                <h1>验证码：</h1>  <input type="text" name="code" class="txt_input txt_input2"/><br>
                <div class="rem_sub">
                    <input type="submit" class="sub_button" value="注册"/>
                </div>
            </form>

            <%--<button onclick="sendSms()" >发送邮箱验证码</button>--%>
            <button id="butt" onclick="buttclick()" type="button">发送邮箱验证码</button>
