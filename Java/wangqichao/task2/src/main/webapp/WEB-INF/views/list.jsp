...
<div style="width:1000px;margin:0px auto;text-align: center">
    ...
    <span align="left"><form method="GET" style="display: inline" action="/task2/person/newone">
        <input type="submit" value="新增英雄"/>
    </form></span>&nbsp;&nbsp;&nbsp;
    <span align="center">
    <form method="get" style="display: inline" action="/task2/person/name">
       <input type="text" name="name" value="" size="10" placeholder="请输入姓名">
        <input type="submit" value="姓名查询">
    </form></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <span align="right">
    <form action="/task2/list" style="display: inline" method="get">
    ...
    <table align="center" border="1" cellspacing="0">
        ...
        <tr>
            ...
            <th>
                <form action="http://localhost:8080/task2/person/${person.id}" method="get">
                    <input type="submit" value="查看详情">
                </form>
            </th>
            <th><form action="http://localhost:8080/task2/person/${person.id}" method="post">
