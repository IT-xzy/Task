<%@ page import="com.listener.UserList" %>
...
<div class="section1 w">
    ...
    <div class="right hidden-sm hidden-xs">
        <div class="content">
            <div class="num">
                <img src="images/user.jpg" alt=""> <span>${totalStudent}</span>
                <p>累计学生人数</p>
            </div>
            <div class="num">
                <img src="images/user.jpg" alt=""> <span><%=UserList.getUserCount()%></span>
                <p>累计登录学生人数</p>
            </div>
        </div>
    </div>
...
<div class="section3 w container">
    ...
    <div class="row xueyuan">
        ...
        <c:forEach items="${data}" var="student" varStatus="now">
        ...
        <div class="people col-xs-12 col-sm-12 col-md-3">
            ...
            <span>${student.introduction}。创建时间：<date:date value="${student.createAt}"/> </span>
        </div>
        </c:forEach>
    </div>
...
<!-- 中间第四部分 -->
<div class="section4 w container" style="margin-top: 50px">
    <p><a href="${pageContext.request.contextPath}/company">战略合作企业</a></p>
    <ul class="com row">
