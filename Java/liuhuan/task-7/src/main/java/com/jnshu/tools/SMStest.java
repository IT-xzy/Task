 ...
 * @description: 短信测试
 * @author: Mr.xweiba
 * @create: 2018-05-28 23:40
 **/

public class SMStest {
    public static void main(String[] args) {
        HashMap<String, Object> result = null;
        String telephone_Number = "17032333212";
        String Rand_Code = RandNum.getRandLength(4);
        // 初始化SDK
        ...
        restAPI.setAccount("8a216da86391c1fa0163a705b6ee05d7", "5b359ec65aeb499dab4795308cbe4ae7");
