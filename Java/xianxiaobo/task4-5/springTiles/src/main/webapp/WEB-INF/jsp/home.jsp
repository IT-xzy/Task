...
<div id="myCarousel" class="carousel slide">
    ...
    <div class="carousel-inner">
        <div class="item active">
            <img alt="First slide" src="/static/image/547567.jpg">
        </div>
        <div class="item">
            <img alt="Second slide" src="/static/image/547567.jpg">
        </div>
        <div class="item">
            <img alt="Third slide" src="/static/image/547567.jpg">
        </div>
        <div class="item">
            <img alt="Third slide" src="/static/image/547567.jpg">
        </div>
        <a data-slide="prev" href="#myCarousel" class="carousel-control left">
            <i class="icon-left"><img src="/static/image/54354.png"></i>
        </a>
        <a data-slide="next" href="#myCarousel" class="carousel-control right">
            <i class="icon-right"><img src="/static/image/4525424.png"></i>
        </a>
    </div>
</div>
