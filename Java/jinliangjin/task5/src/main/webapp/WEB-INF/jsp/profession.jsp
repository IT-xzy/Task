...
<div class="occupation">
    <div class="container">
        ...
        <div class="row">
            <span class="bg-color-gray">方向:&nbsp;&nbsp;全部&nbsp;&nbsp;
                ...
                <a href="${pageContext.request.contextPath}/it/profession/op">运营维护</a></span>
        </div>
    </div>
</div>
<main>
    <div class="container">
        <div class="row nav-strong">
            ...
            <c:forEach items="${professions_fe}" var="item">
                <div class="col-xs-12 col-sm-6 col-md-4">
                    <div class="warp">
                        <table border="1" class="text">
                            <tr>
                                <th>
                                    <img src="${pageContext.request.contextPath}/images/img022.png" alt=""
                                         class="avast">
                                </th>
                                <td>
                            ...
                            <tr>
                                <c:if test="${!empty item.entryBarrier && item.entryBarrier > 0}">
                                    <c:if test="${item.entryBarrier == 1}">
                                        <td>门槛<img src="${pageContext.request.contextPath}/images/star.png" alt=""></td>
                                    </c:if>
                                    <c:if test="${item.entryBarrier == 2}">
                                        <td>门槛<img src="${pageContext.request.contextPath}/images/star.png" alt="">
                                            <img src="${pageContext.request.contextPath}/images/star.png" alt=""></td>
                                    </c:if>
                                    <c:if test="${item.entryBarrier == 3}">
                                        <td>门槛<img src="${pageContext.request.contextPath}/images/star.png" alt="">
                                            <img src="${pageContext.request.contextPath}/images/star.png" alt="">
                                            <img src="${pageContext.request.contextPath}/images/star.png" alt=""></td>
                                    </c:if>
                                ...
                                <c:if test="${!empty item.difficulty && item.difficulty > 0}">
                                    <c:if test="${item.difficulty == 1}">
                                        <td>难易程度<img src="${pageContext.request.contextPath}/images/star.png" alt="">
                                        </td>
                                    </c:if>
    ...
    <div class="container">
        <div class="row nav-strong">
            ...
            <c:forEach items="${professions_be}" var="item">
                <div class="col-xs-12 col-sm-6 col-md-4">
                    <div class="warp">
                        <table border="1" class="text">
                            <tr>
                                <th><img src="${pageContext.request.contextPath}/images/img022.png" alt=""
                                         class="avast"></th>
                                <td>
                                    <strong>${item.profession}</strong>
                                    <p>${item.description}</p>
            ...
            <c:forEach items="${professions_op}" var="item">
                <div class="col-xs-12 col-sm-6 col-md-4">
                    <div class="warp">
                        <table border="1" class="text">
                            <tr>
                                <th><img src="${pageContext.request.contextPath}/images/img022.png" alt="" class="avast"></th>
                                <td>
                                    <strong>${item.profession}</strong>
                                    <p>${item.description}</p>
                                </td>
                            ...
                            <tr>
                                ...
                                <c:if test="${!empty item.difficulty && item.difficulty > 0}">
                                    <c:if test="${item.difficulty == 1}">
                                        <td>难易程度<img src="${pageContext.request.contextPath}/images/star.png" alt=""></td>
                                    </c:if>
                                    <c:if test="${item.difficulty == 2}">
                                        <td>难易程度<img src="${pageContext.request.contextPath}/images/star.png" alt="">
                                            <img src="${pageContext.request.contextPath}/images/star.png" alt=""></td>
    ...
    <div class="container">
        <div class="row nav-strong">
            <strong>移动开发方向</strong>
            <c:forEach items="${professions_mobile}" var="item">
                <div class="col-xs-12 col-sm-6 col-md-4">
                    <div class="warp">
                        <table border="1" class="text">
                            <tr>
    ...
    <div class="container">
        <div class="row nav-strong">
            <strong>整站开发</strong>
            <c:forEach items="${professions_fs}" var="item">
                <div class="col-xs-12 col-sm-6 col-md-4">
                    <div class="warp">
                        <table border="1" class="text">
                            <tr>
