                            ...
                            <tr>
                                <c:if test="${!empty item.entryBarrier && item.entryBarrier > 0}">
                                    ...
                                    <c:if test="${item.entryBarrier == 2}">
                                        <td>门槛<img src="../images/star.png" alt="">
                                            <img src="../images/star.png" alt=""></td>
                                    </c:if>
                                ...
                                <c:if test="${!empty item.difficulty && item.difficulty > 0}">
                                    <c:if test="${item.difficulty == 1}">
                                        <td>难易程度<img src="../images/star.png" alt="">
                                        </td>
                                    </c:if>
            ...
            <c:forEach items="${professions_be}" var="item">
                <div class="col-xs-12 col-sm-6 col-md-4">
                    <div class="warp">
                        <table border="1" class="text">
                            <tr>
                                <th><img src="../images/img022.png" alt=""
                                         class="avast"></th>
                                <td>
                                    <strong>${item.profession}</strong>
                                    <p>${item.description}</p>
