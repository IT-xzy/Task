    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-3 text-center number">
                <strong><img src="../images/logo04.png" alt="">${studyStudentCount}</strong>
                <span class="gy">累计在线学习人数</span>
                <strong><img src="../images/logo04.png" alt="">${graduateStudentCount}</strong>
        ...
        <div class="row text-center">
            ...
            <div class="cooperation-warp col-xs-12 col-sm-12">
                <div class="col-xs-12 col-sm-2 img-shadow media-img-shadow">
                    <img src="../images/qy1.png" alt="" class="img-responsive">
                </div>
                <div class="col-xs-12 col-sm-2 img-shadow media-img-shadow">
                    <img src="../images/qy2.png" alt="" class="img-responsive">
                </div>
                <div class="col-xs-12 col-sm-2 img-shadow media-img-shadow">
                    <img src="../images/qy3.png" alt="" class="img-responsive">
                </div>
                <div class="col-xs-12 col-sm-2 img-shadow media-img-shadow">
                    <img src="../images/qy4.png" alt="" class="img-responsive">
                </div>
                <div class="col-xs-12 col-sm-2 img-shadow media-img-shadow">
                    <img src="../images/qy5.png" alt="" class="img-responsive">
                </div>
            </div>
        </div>
    </div>
