...
<body>
<div class="center">
    <form style="text-align:center;" action="${ctx}/sms/user" method="post">
        ...
        <input name="tel" id="tel" type="text" placeholder="手机号码" required><br><br>
        <input name="userCode" type="text" placeholder="验证码"required><br><br>
