...
<head>
    ...
    <title>无标题文档</title>
    <link href="${ctx}/static/cssJs/bootstrap.min.css" rel="stylesheet" type="text/css">
    <%--    <link href="../bootstrap-3.3.5-dist/css/bootstrap.css">--%>
    <link href="${ctx}/static/cssJs/Untitled-3.css" rel="stylesheet" type="text/css">
    <link href="${ctx}/static/cssJs/Untitled-1base.css" rel="stylesheet" type="text/css">
...
<div id="myCarousel" class="carousel slide">
    ...
    <div class="carousel-inner">
        <div class="item active">
            <img alt="First slide" src="${ctx}/static/png/547567.jpg">
        </div>
        <div class="item">
            <img alt="Second slide" src="${ctx}/static/png/547567.jpg">
        </div>
        <div class="item">
            <img alt="Third slide" src="${ctx}/static/png/547567.jpg">
        </div>
        <div class="item">
            <img alt="Third slide" src="${ctx}/static/png/547567.jpg">
        </div>
        <a data-slide="prev" href="#myCarousel" class="carousel-control left">
            <i class="icon-left"><img src="${ctx}/static/png/54354.png"></i>
        </a>
        <a data-slide="next" href="#myCarousel" class="carousel-control right">
            <i class="icon-right"><img src="${ctx}/static/png/4525424.png"></i>
        </a>
    </div>
</div>
...
<div class="main container">
    ...
    <div class="main-a row">
            ...
            <div class="row text-center">
                <ul class="list-unstyled">
                    <li class="col-xs-12 up-1">
                        <img alt="" src="${ctx}/static/png/45354312.png">
                    </li>
        ...
        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
            <div class="row text-center">
                <ul class="list-unstyled">
                    <li class="col-xs-12 up-1">
                        <img alt="" src="${ctx}/static/png/879789.png">
                    </li>
        ...
        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
            <div class="row text-center">
                <ul class="list-unstyled">
                    <li class="col-xs-12 up-1">
                        <img alt="" src="${ctx}/static/png/786453654365.png">
                    </li>
        ...
        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3 text-center">
            <p>
                <img src="${ctx}/static/png/453254312.png">12400<br>
    ...
    <div class="main-c row">
        ...
        <ul class="list-unstyled text-center">
            <li class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
                <div>
                    <img src="${ctx}/${excellencelist.get(0).photograph}">
                    <span>${excellencelist.get(0).position}:${excellencelist.get(0).name}</span>
                    <p class="text-left">${excellencelist.get(0).introduction}</p>
                </div>
            </li>
            <li class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
                <div>
                    <img src="${ctx}/${excellencelist.get(1).photograph}">
                    <span>${excellencelist.get(1).position}:${excellencelist.get(1).name}</span>
                    <p class="text-left">${excellencelist.get(1).introduction}</p>
                </div>
            </li>
            <li class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
                <div>
                    <img src="${ctx}/${excellencelist.get(2).photograph}">
                    <span>${excellencelist.get(2).position}:${excellencelist.get(2).name}</span>
                    <p class="text-left">${excellencelist.get(2).introduction}</p>
                </div>
            </li>
            <li class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
                <div>
                    <img src="${ctx}/${excellencelist.get(3).photograph}">
                    <span>${excellencelist.get(3).position}:${excellencelist.get(3).name}</span>
                    <p class="text-left">${excellencelist.get(3).introduction}</p>
                </div>
            </li>
        </ul>
    </div>
    ...
    <div class="row main-bottom">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <ul class="logo">
                <li>
                    <a href=""><img src="${ctx}/static/png/123132.png"></a>
                </li>
                <li>
                    <a href=""> <img src="${ctx}/static/png/1549865.png"></a>
                </li>
                <li>
                    <a href=""> <img src="${ctx}/static/png/785345.png"></a>
                </li>
                <li>
                    <a href=""> <img src="${ctx}/static/png/1471.png"></a>
                </li>
                <li>
                    <a href="">  <img src="${ctx}/static/png/7861.png"></a>
                </li>
            </ul>
        </div>
    </div>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-4 col-md-2 col-lg-2 up-3">
                <p>微信公众平台</p>
                <img alt="" src="${ctx}/static/png/2524.jpg">
            </div>
        </div>
    </div>
