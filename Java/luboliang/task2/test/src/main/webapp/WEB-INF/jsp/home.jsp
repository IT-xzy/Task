...
<td><a href="/home?currentPage=1">首页</a></td>
<td><a href="/home?currentPage=${page.nextPage}">下一页</a></td>
<td><a href="/home?currentPage=${page.prefPage}">上一页</a></td>
<td><a href="/home?currentPage=${page.totalPages}">尾页</a></td>
<form name="" action="/home">
到:<input type="text" name="currentPage" /> 页<br>
<input type="submit" value="gou">
    </form>
<td><a href="/students">添加数据</a></td>
