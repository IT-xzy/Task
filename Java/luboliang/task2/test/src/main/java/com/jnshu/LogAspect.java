...
public class LogAspect {
    ...
    //value中为切入点表达式
//    @Before(value = "execution(public * com.jnshu.*.*.*(..))")//前置通知
//    public void showBeginLog() {
//        System.out.println("AOP日志开始");
//    }
//
//    @After(value = "execution(public * com.jnshu.*.*.*(..))")//后置通知
//    public void showReturnLog() {
//        System.out.println("AOP方法结束");
//    }
//
//    @AfterThrowing(value = "execution(public * com.jnshu.*.*.*(..))")//异常通知
//    public void showExceptionLog() {
//        System.out.println("AOP方法异常");
//    }
//
//    @AfterReturning(value = "execution(public * com.jnshu.*.*.*(..))")//返回通知
...
//    }
    ...
    @Around(value = "execution(public * com.jnshu.MyBatis.StudentMapper.*(..))")
