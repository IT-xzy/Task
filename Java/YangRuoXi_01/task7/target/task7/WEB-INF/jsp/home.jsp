...
<div class="main container">
    ...
    <div class="main-a row">
            ...
            <div class="row text-center">
                <ul class="list-unstyled">
                    <li class="col-xs-12 up-1">
                        <img alt="" src="${pageContext.request.contextPath}/static/img/45354312.png">
                    </li>
        ...
        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
            <div class="row text-center">
                <ul class="list-unstyled">
                    <li class="col-xs-12 up-1">
                        <img alt="" src="${pageContext.request.contextPath}/static/img/879789.png">
                    </li>
        ...
        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
            <div class="row text-center">
                <ul class="list-unstyled">
                    <li class="col-xs-12 up-1">
                        <img alt="" src="${pageContext.request.contextPath}/static/img/786453654365.png">
                    </li>
        ...
        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3 text-center">
            <p>
                <img src="${pageContext.request.contextPath}/static/img/453254312.png">12400<br>
    ...
    <div class="main-c row">
        ...
        <ul class="list-unstyled text-center">
            ...
            <c:forEach items="${userList}" var="users">
                <li class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
                    <div>
                        <img src="${pageContext.request.contextPath}${users.img}"/>
                        <span>${users.name}</span>
                        <p class="text-left">${users.description}</p>
                        <span>
                            <jsp:useBean id="dateValue" class="java.util.Date" ></jsp:useBean>
                            <jsp:setProperty name="dateValue" property="time" value="${users.createAt}"/>
                            <fmt:formatDate value="${dateValue}" pattern="yyyy-MM-dd HH:mm:ss" /></span>
                    </div>
                </li>
            </c:forEach>
                <%--<date:date value="${users.createAt}"></date:date>--%>
                <%--<fmt:parseDate value="${users.createAt}" pattern="yyyy-MM-dd HH:mm:ss" var="date"/>--%>

            <%--<div>--%>
                <%--<img src="/static/img/242424.png">--%>
                <%--<span>技术顾问:罗大佑</span>--%>
    ...
    <div class="row main-bottom">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <ul class="logo">
                <li>
                    <a href=""><img src="${pageContext.request.contextPath}/static/img/123132.png"></a>
                </li>
                <li>
                    <a href=""> <img src="${pageContext.request.contextPath}/static/img/1549865.png"></a>
                </li>
                <li>
                    <a href=""> <img src="${pageContext.request.contextPath}/static/img/785345.png"></a>
                </li>
                <li>
                    <a href=""> <img src="${pageContext.request.contextPath}/static/img/1471.png"></a>
                </li>
                <li>
                    <a href=""> <img src="${pageContext.request.contextPath}/static/img/7861.png"></a>
                </li>
            </ul>
        </div>
    </div>
