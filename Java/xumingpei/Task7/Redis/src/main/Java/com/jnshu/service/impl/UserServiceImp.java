...
import com.jnshu.pojo.tool.MailUtil;
import com.jnshu.pojo.tool.SMS;
import com.jnshu.pojo.tool.Uploadphoto;
import com.jnshu.pojo.tool.UuidUtil;
import com.jnshu.pojo.tool.redis.Redis;
...
//                msgStatus = "true";
    ...
    @Override
    public String upload(User user, MultipartFile multipartFile, String url) {

//        multipartFile.getOriginalFilename();
        CommonsMultipartFile cf = (CommonsMultipartFile) multipartFile;
        DiskFileItem fi = (DiskFileItem) cf.getFileItem();
        File file = fi.getStoreLocation();
        String fileName = UuidUtil.getUUID (multipartFile);
