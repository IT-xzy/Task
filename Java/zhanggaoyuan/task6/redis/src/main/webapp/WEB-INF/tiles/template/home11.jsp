...
<c:set var="sss" value="${p.salary}"></c:set>
        ...
        <div class="col-md-4 col-sm-6 col-xs-12 top-margin">
            ...
            <div class="warp-border">
                <div class="clearfix">
                    <div class="icon-people"><img src="${pageContext.request.contextPath}/static/imges/${p.img}"></div>
                    <div class="text">
                ...
                <div class="warp-class2">
                    <div class="warp-class2-text">
                        <div class="iconfont text-padding">门槛  <c:forEach   begin="1" end="${p.threshold}" ><img src="${pageContext.request.contextPath}/static/imges/t11/imges/xx.png"></c:forEach></div>
                    </div>
                    <div class="warp-class2-text">
                        <div class="iconfont text-padding text-border-left">难易程度  <c:forEach begin="1" end="${p.difficultyLevel}" ><img src="${pageContext.request.contextPath}/static/imges/t11/imges/xx.png"></c:forEach></div>
                    </div>
                </div>
                <div class="warp-class2">
                    <div class="warp-class2-text">
