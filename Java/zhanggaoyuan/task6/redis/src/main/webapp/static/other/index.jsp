...
<link href="${pageContext.request.contextPath}/static/other/Untitled-1base.css1base.css" rel="stylesheet" type="text/css">
</head>
<body>
...
<script  src="${pageContext.request.contextPath}/static/other/bootstrap.min.jsap.min.js"></script>
</html>