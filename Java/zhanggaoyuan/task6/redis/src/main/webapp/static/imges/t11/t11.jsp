...
<link href="${pageContext.request.contextPath}/static/other/base.css" rel="stylesheet" type="text/css">
</head>
...
<header>
    <div class="top container">
        ...
        <img src="${pageContext.request.contextPath}/static/imges/t11/imges/12321.gif">
    </div>

    <div role="navigation" class="nav1 navbar navbar-default">
        <div class="container">
            <div class="header-logo">
                <div class="logo-middle"><img src="${pageContext.request.contextPath}/static/imges/t11/imges/logo.png"></div>
            </div>
        ...
        <div class="row">
            <div class="col-md-4 col-sm-6 col-xs-12 top-margin">
                ...
                <div class="warp-border">
                    <div class="clearfix">
                        <div class="icon-people"><img src="${pageContext.request.contextPath}/static/imges/t11/imges/687.png"></div>
                        <div class="text">
                    ...
                    <div class="warp-class2">
                        <div class="warp-class2-text">
                            <div class="iconfont text-padding">门槛 <img src="${pageContext.request.contextPath}/static/imges/t11/imges/xx.png"></div>
                        </div>
                        <div class="warp-class2-text">
                            <div class="iconfont text-padding text-border-left">难易程度 <img src="${pageContext.request.contextPath}/static/imges/t11/imges/xx.png"><img src="${pageContext.request.contextPath}/static/imges/t11/imges/xx.png"></div>
                        </div>
                    </div>
                    <div class="warp-class2">
                        <div class="warp-class2-text">
    ...
    <div class="container height">
        <div class="row">
            ...
            <div class="text-right col-sm-4">
                <p>微信公众号</p>
                <img src="${pageContext.request.contextPath}/static/imges/t11/imges/2524.jpg">
            </div>
        </div>
