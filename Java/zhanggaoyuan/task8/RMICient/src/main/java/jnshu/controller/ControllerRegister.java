...
public class ControllerRegister {
    ...
    private Map takMD5(RMIClient  rmiClient, RestUser restUser){
...
//        给密码加密
        ...
        int rt = rmiClient.getStudentService ().insertUser (restUser);//把数据存入数据库，可以做异常捕捉
        ModelAndView mv = new ModelAndView ();
...
//      登录失败返回首页
        ...
        Map map=takMD5 (rmiClient,restUser );
