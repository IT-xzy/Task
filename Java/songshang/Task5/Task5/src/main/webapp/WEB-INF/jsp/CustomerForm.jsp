...
<div id="myCarousel" class="carousel slide">
    ...
    <div class="carousel-inner">
        <div class="item active">
            <img alt="First slide" src="${ctx}/statics/png/547567.jpg">
        </div>
        <div class="item">
            <img alt="Second slide" src="${ctx}/statics/png/547567.jpg">
        </div>
        <div class="item">
            <img alt="Third slide" src="${ctx}/statics/png/547567.jpg">
        </div>
        <div class="item">
            <img alt="Third slide" src="${ctx}/statics/png/547567.jpg">
        </div>
        <a data-slide="prev" href="#myCarousel" class="carousel-control left">
            <i class="icon-left"><img src="${ctx}/statics/png/54354.png"></i>
        </a>
        <a data-slide="next" href="#myCarousel" class="carousel-control right">
            <i class="icon-right"><img src="${ctx}/statics/png/4525424.png.png"></i>
        </a>
    </div>
</div>
...
<div class="main container">
    ...
    <div class="main-a row">
            ...
            <div class="row text-center">
                <ul class="list-unstyled">
                    <li class="col-xs-12 up-1">
                        <img alt="" src="${ctx}/statics/png/45354312.png">
                    </li>
                    <li class="up-2 col-xs-12">高效<a href="${ctx}/u/delete">注销</a><br/></li>
        ...
        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
            <div class="row text-center">
                <ul class="list-unstyled">
                    <li class="col-xs-12 up-1">
                        <img alt="" src="${ctx}/statics/png/879789.png">
                    </li>
        ...
        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
            <div class="row text-center">
                <ul class="list-unstyled">
                    <li class="col-xs-12 up-1">
                        <img alt="" src="${ctx}/statics/png/786453654365.png">
                    </li>
        ...
        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3 text-center">
            <p>
                <img src="${ctx}/statics/png/453254312.png">${count.online}<br>
                <span class="up-3">累计在线学习人数</span>
            </p>
            <p>
                <img src="${ctx}/statics/png/453254312.png">${count.workers}<br>
    ...
    <div class="main-c row">
        ...
        <ul class="list-unstyled text-center">
            <c:forEach var="excellencelist" items="${excellencelist}">
                <li class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
                    <div>
                        <img src="${excellencelist.coding}">
                        <span>${excellencelist.name}:${excellencelist.duty}</span>
                        <p class="text-left">${excellencelist.introduction}</p>
                    </div>
                </li>
            </c:forEach>
    ...
    <%--<ul class="logo">--%>
    <%--<li>--%>
    <%--<a href=""><img src="${ctx}/statics/png/1549865.png"></a>--%>
    <%--</li>--%>
    <%--<li>--%>
    <%--<a href=""> <img src="${ctx}/statics/png/1549865.png"></a>--%>
    <%--</li>--%>
    <%--<li>--%>
    <%--<a href=""> <img src="${ctx}/statics/png/785345.png"></a>--%>
    <%--</li>--%>
    <%--<li>--%>
    <%--<a href=""> <img src="${ctx}/statics/png/1471.png"></a>--%>
    <%--</li>--%>
    <%--<li>--%>
    <%--<a href="">  <img src="${ctx}/statics/png/7861.png"></a>--%>
    <%--</li>--%>
    <%--</ul>--%>
    <%--</div>--%>
    <%--</div>--%>
    ...
    <%--<p>微信公众平台</p>--%>
    <%--<img alt="" src="${ctx}/statics/png/2524.jpg">--%>
    <%--</div>--%>
    <%--</div>--%>
    <%--</div>--%>
