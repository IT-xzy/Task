    ...
    <table border="1">
        ...
        <c:forEach items="${studentList}" var="student" varStatus="st">
            <tr>
                ...
                <td><a href="${pageContext.request.contextPath}/listStudent3/${student.lineId}">更新</a></td>

                <!--第三步：为超链接添加class属性，根据class改变其请求方式-->
                <td><a class="delete" href="${pageContext.request.contextPath}/listStudent3/${student.lineId}">删除</a></td>
            </tr>
        </c:forEach>
    </table>
...
<div style="text-align:center;margin-top:40px">
    <form method="post" action="${pageContext.request.contextPath}/listStudent3" accept-charset="UTF-8">
...
<div style="text-align:center;margin-top:40px">
    <form method="post" action="${pageContext.request.contextPath}/editStudent3" accept-charset="UTF-8">
        学生ID： <input name="lineId" value="${student.lineId}" type="text"> <br><br>
