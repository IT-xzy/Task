...
<head>
    ...
    <link href="statics/css/Untitled-3.css" rel="stylesheet" type="text/css">
    <link href="statics/css/Untitled-1base.css" rel="stylesheet" type="text/css">
</head>
<body>
<div class="container  hidden-xs">
    <div class="row header-top">
        ...
        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 text-right">
            <div>
                <a href="#" target="_blank"> <img alt=""  src="statics/imges/54537.png"></a>
                <a href="#" target="_blank"><img alt=""  src="statics/imges/45678678.png"></a>
                <a href="#" target="_blank"> <img alt=""  src="statics/imges/54375483543.png"></a>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="container">
        <div class="navbar-header">
            <a href="#" class="navbar-brand">
                <img src="statics/imges/logo.png" alt="Brand" class="img-responsive">
            </a>
...
<div id="myCarousel" class="carousel slide">
    ...
    <div class="carousel-inner">
        <div class="item active">
            <img alt="First slide" src="statics/imges/547567.jpg">
        </div>
        <div class="item">
            <img alt="Second slide" src="statics/imges/547567.jpg">
        </div>
        <div class="item">
            <img alt="Third slide" src="statics/imges/547567.jpg">
        </div>
        <div class="item">
            <img alt="Third slide" src="statics/imges/547567.jpg">
        </div>
        <a data-slide="prev" href="#myCarousel" class="carousel-control left">
            <i class="icon-left"><img src="statics/imges/54354.png"></i>
        </a>
        <a data-slide="next" href="#myCarousel" class="carousel-control right">
            <i class="icon-right"><img src="statics/imges/4525424.png"></i>
        </a>
    </div>
</div>
...
<div class="main container">
    ...
    <div class="main-a row">
            ...
            <div class="row text-center">
                <ul class="list-unstyled">
                    <li class="col-xs-12 up-1">
                        <img alt="" src="statics/imges/45354312.png">
                    </li>
        ...
        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
            <div class="row text-center">
                <ul class="list-unstyled">
                    <li class="col-xs-12 up-1">
                        <img alt="" src="statics/imges/879789.png">
                    </li>
        ...
        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
            <div class="row text-center">
                <ul class="list-unstyled">
                    <li class="col-xs-12 up-1">
                        <img alt="" src="statics/imges/786453654365.png">
                    </li>
        ...
        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3 text-center">
            <p>
                <img src="statics/imges/453254312.png">${countstudy}<br>
                <span class="up-3">累计在线学习人数</span>
            </p>
            <p>
                <img src="statics/imges/453254312.png">${countwork}<br>
    ...
    <div class="main-c row">
        ...
        <ul class="list-unstyled text-center">
            <li class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
                <div>
                    <img src="statics/imges/242424.png">
    ...
    <div class="row main-bottom">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <ul class="logo">
                <li>
                    <a href=""><img src="statics/imges/123132.png"></a>
                </li>
                <li>
                    <a href=""> <img src="statics/imges/1549865.png"></a>
                </li>
                <li>
                    <a href=""> <img src="statics/imges/785345.png"></a>
                </li>
                <li>
                    <a href=""> <img src="statics/imges/1471.png"></a>
                </li>
                <li>
                    <a href="">  <img src="statics/imges/7861.png"></a>
                </li>
            </ul>
        </div>
    </div>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-4 col-md-2 col-lg-2 up-3">
                <p>微信公众平台</p>
                <img alt="" src="statics/imges/2524.jpg">
            </div>
        </div>
    </div>
