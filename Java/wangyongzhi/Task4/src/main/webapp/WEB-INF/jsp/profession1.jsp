...
<head>
    ...
    <link href="statics/css/t11.css" rel="stylesheet" type="text/css">
...
<header>
    <div class="top container">
        ...
        <img src="statics/imges/12321.gif">
    </div>

    <div role="navigation" class="nav1 navbar navbar-default">
        <div class="container">
            <div class="header-logo">
                <div class="logo-middle"><img src="statics/imges/logo.png"></div>
            </div>
    ...
    <div class="row">
        <div class="col-md-4 col-sm-6 col-xs-12 top-margin">
            ...
            <div class="warp-border">
                <div class="clearfix">
                    <div class="icon-people"><img src="statics/imges/687.png"></div>
                    <div class="text">
                        <h4 class="">${prof.profession}</h4>
                        <p class="text-present">${prof.profession}，${prof.introduction}</p>
                    </div>
                </div>
                ...
                <div class="warp-class2">
                    <div class="warp-class2-text">
                        <div class="iconfont text-padding">门槛
                            <c:choose>
                                <c:when test="${prof.threshold >= 1}">
                                    <img src="statics/imges/xx.png">
                                </c:when>
                            </c:choose>
                            <c:choose>
                                <c:when test="${prof.threshold >= 2}">
                                    <img src="statics/imges/xx.png">
                                </c:when>
                            </c:choose>
                            <c:choose>
                                <c:when test="${prof.threshold >= 3}">
                                    <img src="statics/imges/xx.png">
                                </c:when>
                            </c:choose>
                            <c:choose>
                                <c:when test="${prof.threshold >= 4}">
                                    <img src="statics/imges/xx.png">
                                </c:when>
                            </c:choose>
                            <c:choose>
                                <c:when test="${prof.threshold >= 5}">
                                    <img src="statics/imges/xx.png">
                                </c:when>
                            </c:choose>
                        </div>
                    ...
                    <div class="warp-class2-text">
                        <div class="iconfont text-padding text-border-left">难易程度
                            <c:choose>
                                <c:when test="${prof.difficulty >= 1}">
                                    <img src="statics/imges/xx.png">
                                </c:when>
                            </c:choose>
                            <c:choose>
                                <c:when test="${prof.difficulty >= 2}">
                                    <img src="statics/imges/xx.png">
                                </c:when>
                            </c:choose>
                            <c:choose>
                                <c:when test="${prof.difficulty >= 3}">
                                    <img src="statics/imges/xx.png">
                                </c:when>
                            </c:choose>
                            <c:choose>
                                <c:when test="${prof.difficulty >= 4}">
                                    <img src="statics/imges/xx.png">
                                </c:when>
                            </c:choose>
                            <c:choose>
                                <c:when test="${prof.difficulty >= 5}">
                                    <img src="statics/imges/xx.png">
                                </c:when>
                            </c:choose>
                        </div>
                ...
                <div class="warp-class2">
                    <div class="warp-class2-text">
                        <div class="iconfont text-padding">成长周期 <span class="iconfont-color">${prof.growthPeriod}</span>年</div>
                    </div>
                    <div class="warp-class2-text">
                        <div class="iconfont text-padding text-border-left">稀缺程度 <span class="iconfont-color">${prof.rareness}</span>家公司需要
                        </div>
                    </div>
                </div>
                ...
                <div class="warp-class2">
                    ...
                    <div class="rightWarp">
                        <div class="rightWarp-class">
                            ...
                            <div class="rightWarp-wages">${prof.firstSalary}</div>
                        </div>
                        <div class="rightWarp-class">
                            <div class="rightWarp-year">1-3年</div>
                            <div class="rightWarp-wages">${prof.secondSalary}</div>
                        </div>
                        <div class="rightWarp-class border-bottom">
                            <div class="rightWarp-year">5-10年</div>
                            <div class="rightWarp-wages">${prof.thirdSalary}</div>
                        </div>
                    </div>
                </div>
                ...
                <div class="warp-class2">
                    <p class="text-p">提示:在你学习之前你应该已经掌握${prof.request}等语言基础</p>
                </div>

                <div class="flip-container">
                    <p class="flip-title">${prof.profession}</p>
                    <p class="flip-text">${prof.profession}${prof.introduction}</p>
                </div>
            </div>
        ...
        <div class="col-md-4 col-sm-6 col-xs-12 top-margin">
            ...
            <div class="warp-border">
                ...
                <div class="warp-class2">
                    <div class="warp-class2-text">
                        <div class="iconfont text-padding">门槛 <img src="statics/imges/xx.png"></div>
                    </div>
                    <div class="warp-class2-text">
                        <div class="iconfont text-padding text-border-left">难易程度 <img src="statics/imges/xx.png"><img
                                src="statics/imges/xx.png"></div>
                    </div>
                </div>
                <div class="warp-class2">
                    <div class="warp-class2-text">
