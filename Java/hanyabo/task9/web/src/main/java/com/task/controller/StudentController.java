...
//    StudentService studentService;
    ...
    private StudentService getStudentService() throws RemoteException, NotBoundException, MalformedURLException {
        return new TuscanyServiceUtil().getStudentService();
    }
    ...
    public ModelAndView listStudentById(String id,String name,String number) throws RemoteException, NotBoundException, MalformedURLException {
    ...
    public ModelAndView listStudentByPage(StudentPage studentPage) throws RemoteException, NotBoundException, MalformedURLException {
