...
//    private UserService userServivce;
    ...
    private UserService getUserServivce(){
        return new BeanFactoryUtil().getUserService();
    }
...
//                }
    ...
    public ModelAndView addUser(User user,String checkCode,HttpServletRequest request){
        ...
        if((checkCode).equals(sessioncode)){//验证码对比相等
            ...
            ret = userServivce.checkLogin(user);
