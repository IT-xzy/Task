...
<form action="/ssm/select" method="get"  align='center'>
    <input name="id" type="text" placeholder="请输入查询ID" required="required">
    <input type="submit" value="查找">
</form>
<a href="/ssm/listStudent"  >****返回目录****</a>
<a href="/ssm/add" >****添加****</a>
<table align='center' border='1' width="100%" cellspacing='0'>
    ...
    <c:forEach items="${cs}" var="c" varStatus="st">
        <tr>
            ...
            <td>${c.name}</td>
            <td>${c.age}</td>
            <td><a href="/ssm/student/profile/${c.id}">更新</a></td>
            <td><a href="/ssm/student/${c.id}">删除</a></td>
