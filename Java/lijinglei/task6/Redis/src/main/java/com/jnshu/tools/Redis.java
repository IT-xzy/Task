...
//    private RedisTemplate redisTemplate;
     ...
     * @return
     */
    public <T> ValueOperations<String, T> setCacheObject(String key, T value) throws Exception {
    ...
    public <T> ValueOperations<String, T> setCacheObject(String key, T value,int time) throws Exception {
        ValueOperations<String, T> operations = redisTemplate.opsForValue();
