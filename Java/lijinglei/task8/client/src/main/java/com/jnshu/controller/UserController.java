...
//    ESService rmiClient.geteSService() = rmiClient.geteSService();
//    JIService rmiClient.getJiService() = rmiClient.getJiService();
//    SNService rmiClient.getSnService() = rmiClient.getSnService();
//    UserService rmiClient.getUserService() = rmiClient.getUserService();
    ...
    public String index(HttpServletRequest request) {
        try {
            ...
            List<ExcellentStudent> student = rmiClient.geteSService().listAll();
            StudentNum num = rmiClient.getSnService().findById(1);
    ...
    public String vocation(HttpServletRequest request) {
        try {
            ...
            List<JobInfo> info = rmiClient.getJiService().listAll();
    ...
    public String login(User user, HttpServletRequest request, HttpServletResponse response) {
        try {
            ...
            String salt = rmiClient.getUserService().selectByName(user.getUserName()).getSalt();
            String psSalt = MD5Util.generate(password, salt);
            boolean loginUser = psSalt.equals(rmiClient.getUserService().selectByName(user.getUserName()).getPassword());
            if (loginUser = true) {
