    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="example-navbar-collapse">
            <ul class="nav navbar-nav">
                <li href="#">
                    <a href="${pageContext.request.contextPath}/jnshu">首页</a>
                </li>
                <li>
                    <a href="${pageContext.request.contextPath}/joblist">职业</a>
                </li>
                <li>
                    <a href="#">推荐</a>
                </li>
                <li>
                    <a href="${pageContext.request.contextPath}/cooperation">关于</a>
                </li>
            </ul>
        </div>
    </div>
