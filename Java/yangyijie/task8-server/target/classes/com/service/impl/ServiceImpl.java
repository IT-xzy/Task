...
public class ServiceImpl  extends UnicastRemoteObject implements IService  {
    ...
    @Override
    public List<Student> getStudentByName(String name)throws RemoteException {
    ...
    @Override
    public int selectCount()throws RemoteException {
        return iStudentDao.selectCount();
    }
    
    @Override
    public PageBean<Student> findByPage(int currentPage) throws RemoteException{
