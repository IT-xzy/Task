...
<body>
<h1 style="text-align: center;background: gray">修改信息2</h1><%--三目运算 --%>
<form action="/upStudent" method="post">
    <%--<input type="hidden" name="_method" value="PUT">--%>
    <input type="hidden" 		name="id"			value="${studentInfo.id}" >
    <input type="hidden" 		name="pageCount"			value="${studentInfo.pageCount}" >
    ...
    <br>&nbsp;<input type="submit" 		value="修改" style="width: 161px" >
</form>
</body>
</html>
