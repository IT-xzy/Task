...
import jnshu.pojo.EmailTemplate;
...
public class SmtpEmail {
    ...
    public SmtpEmail(String to,String code)throws Exception{
        sendMail(to,code);
    }
    public void sendMail(String to,String code) throws MessagingException {
        ...
        //4.创建邮件
        //邮件内容
        Message msg=createSimpleMail(session,to,new String(code)+"/"+new Date());
    ...
    private MimeMessage createSimpleMail(Session session, String to,String code) throws AddressException,MessagingException{
        ...
        //设置收件人
        mm.setRecipient(Message.RecipientType.TO, new InternetAddress("@qq.com"));
        //设置抄送人
//            mm.setRecipient(Message.RecipientType.CC, new InternetAddress(email.getCc()));
    ...
    public static void main(String[] args)throws Exception {
        ...
        SmtpEmail test = new SmtpEmail();
        test.sendMail("@qq.com","");
    }
