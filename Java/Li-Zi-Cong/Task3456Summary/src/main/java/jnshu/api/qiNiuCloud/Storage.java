...
//                System.out.println(item.endUser);
                String domainOfBucket = "http://pg3fp6klo.bkt.clouddn.com/";
    ...
    public void test()throws Exception{
        jnshu.api.tencentCloud.Storage storage = new jnshu.api.tencentCloud.Storage();
        URL url = new URL("http://pg3fp6klo.bkt.clouddn.com/tencent/images/1");
        HttpURLConnection httpURLConnection=(HttpURLConnection)url.openConnection();
        storage.transferUpload(httpURLConnection.getInputStream(),"/tencent/imagess",2);
    }
