...
<div class="main container">
    ...
    <div class="main-c row">
        ...
        <ul class="list-unstyled text-center">
            ...
            <c:forEach items="${student}" varStatus="a">
                <li class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
                    <div>
                        <img src=${student.get(a.index).url} width="108" height="108">
                        <span>${student.get(a.index).career}</span>
                          <span>${student.get(a.index).name}</span>
                        <p class="text-left">${student.get(a.index).introduction}                       </p>
                        <p class="text-p">创建时间:</p><date:date value=""/>
                    </div>
                </li>
            </c:forEach>
        </ul>
    ...
    <div class="row main-bottom">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <ul class="logo">
                <c:forEach items="${enterprise}" varStatus="b">

                    <li>
                        <a href=""><img src=${enterprise.get(b.index).url } width="141" height="54"></a>
                    </li>
                </c:forEach>
            </ul>
        </div>
