...
<div class="container">
    ...
    <c:forEach items="${professions}" var="profession" varStatus="now">
        ...
        <div class="col-md-4 col-sm-6 col-xs-12 top-margin">
            ...
            <div class="warp-border">
                ...
                <div class="warp-class2">
                    ...
                    <div class="warp-class2-text">
                        <div class="iconfont text-padding text-border-left">难易程度 <img src=${profession.complexity}><img
                ...
                <div class="warp-class2">
                        <b class="text-b">有${temList[now.index].total}人正在学</b>
                </div>
                <div class="warp-class2">
