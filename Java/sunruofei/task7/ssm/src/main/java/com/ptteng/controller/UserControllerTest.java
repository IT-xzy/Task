...
//                Long dbId = userService.selectByCondition(user.getName(), user.getPassword());
//                User dbUser = userService.selectById(dbId);
//
//                //发一个token
...
//            user.setPassword(MD5Util.MD5(user.getPassword()) + user.getId());
//            logger.info("用户名和密码============="+user.getName()+user.getPassword());
//            Long dbId = userService.selectByCondition(user.getName(), user.getPassword());
//            User dbUser = userService.selectById(dbId);
//            logger.info("数据库==================="+dbUser);
