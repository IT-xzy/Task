...
public class LoginInterceptor implements HandlerInterceptor {
    ...
    public boolean preHandle(HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse, Object o) throws Exception {
        ...
        String token2 = httpServletRequest.getHeader("tokenName");
        String token3 = httpServletResponse.getHeader("tokenName");
        System.out.println("token==========================" + token2 + token3);
        ...
        if (cookies == null) {
            ...
            if (System.currentTimeMillis() - time >= 30 * 60 * 1000) {
                ...
                httpServletResponse.sendRedirect("/loginOK");
                return false;
            }
