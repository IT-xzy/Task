...
<div class="container">
    ...
    <div class="nav-bar">
        ...
        <c:forEach items="${directions}" var="direction">
            <a class="nav-bar-a" href="">${direction.name}</a>
        </c:forEach>
    </div>
            ...
            <div class="warp-border">
                ...
                <div class="warp-class2">
                    <div class="warp-class2-text">
                        <div class="iconfont text-padding">门槛 <img src=${profession.threshold}></div>
                    </div>
                    <div class="warp-class2-text">
                        <div class="iconfont text-padding text-border-left">难易程度 <img src=${profession.complexity}><img src="images/xx.png"></div>
                    </div>
                </div>
                <div class="warp-class2">
                    <div class="warp-class2-text">
                        <div class="iconfont text-padding">成长周期 <span class="iconfont-color">${profession.growthCycle}</span>年</div>
                    </div>
                    <div class="warp-class2-text">
                ...
                <div class="warp-class2">
                    ...
                    <div class="rightWarp">
                        <div class="rightWarp-class">
                            ...
                            <div class="rightWarp-wages">${profession.stageOne}</div>
                        </div>
                        <div class="rightWarp-class">
                            <div class="rightWarp-year">0-1年</div>
                            <div class="rightWarp-wages">${profession.stageTwo}</div>
                        </div>
                        <div class="rightWarp-class border-bottom">
                            <div class="rightWarp-year">0-1年</div>
                            <div class="rightWarp-wages">${profession.stageThree}</div>
                        </div>
                    </div>
                </div>
