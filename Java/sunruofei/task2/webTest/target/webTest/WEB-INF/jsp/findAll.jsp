...
<td><a href="/listtable?pageNow=1">首页</a></td>
<td><a href="/listtable?pageNow=${prePage}">上一页</a></td>
<td><a href="/listtable?pageNow=${nextPage}">下一页</a></td>
<td><a href="/listtable?pageNow=${totalPages}">尾页</a></td>
<td>当前第${pageNow}页</td>
<td>总共${totalPages}页</td>
    <br>
    <form action="/listtable">
