...
<div id="content_section">
    <div class="frame">
        <div id="main_content_section">
            <form action="/registerE" method="post" accept-charset="UTF-8"
                  name="frmLogin">
                <div class="tborder login">
                    <h3 class="catbg"><span class="left"></span><span class="right"></span>
                        登录${result}
                    </h3>
                    <h3 class="catbg"><span class="left"></span><span class="right"></span>邮箱注册</h3>
                            ...
                            <div class="roundframe" id="trad">
                                <dl>
                                    ...
                                    <dt>验证 码:</dt>
                                    <dd><input type="text" name="check" size="20"/></dd>
                                </dl>
