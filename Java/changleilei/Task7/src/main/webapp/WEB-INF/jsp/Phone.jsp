...
<div id="content_section">
    <div class="frame">
        <div id="main_content_section">
            <form action="/PhoneSend" method="post" accept-charset="UTF-8"
                  name="frmLogin" id="frmLogin" onsubmit="hashLoginPassword(this, '780cc737a0a097177013e183d9a57d8a');">
                <div class="tborder login">
                    ...
                    <div class="roundframe" id="trad">
                        <dl>
                            <dt>请输入手机号码:</dt>
                            <dd><input type="text" name="Phone" size="20" class="input_text"/></dd>
                        </dl>
