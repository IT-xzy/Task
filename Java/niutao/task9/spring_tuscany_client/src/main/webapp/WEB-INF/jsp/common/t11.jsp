...
<head>
    ...
    <link href="../../../static/t11.css" rel="stylesheet" type="text/css">
...
<header>
    <div class="top container">
        ...
        <img src="../../../static/imges/12321.gif">
    </div>

    <div role="navigation" class="nav1 navbar navbar-default">
        <div class="container">
            <div class="header-logo">
                <div class="logo-middle"><img src="../../../static/imges/logo.png"></div>
            </div>
    ...
    <div class="row">
        <div class="col-md-4 col-sm-6 col-xs-12 top-margin">
            ...
            <div class="warp-border">
                <div class="clearfix">
                    <div class="icon-people"><img src="../../../static/imges/687.png"></div>
                    <div class="text">
                ...
                <div class="warp-class2">
                    <div class="warp-class2-text">
                        <div class="iconfont text-padding">门槛 <img src="../../../static/imges/xx.png"></div>
                    </div>
                    <div class="warp-class2-text">
                        <div class="iconfont text-padding text-border-left">难易程度 <img src="../../../static/imges/xx.png"><img src="../../../static/imges/xx.png"></div>
                    </div>
                </div>
                <div class="warp-class2">
                    <div class="warp-class2-text">
                ...
                <div class="warp-class2">
                    <b class="text-b">有${learnnum}正在学</b>
                </div>
                <div class="warp-class2">
