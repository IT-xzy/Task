...
<head>
    ...
    <link href="../../../static/Untitled-3.css" rel="stylesheet" type="text/css">
    <link href="../../../static/Untitled-1base.css" rel="stylesheet" type="text/css">
</head>
<body>
<div class="container  hidden-xs">
    <div class="row header-top">
        ...
        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 text-right">
            <div>
                <a href="#" target="_blank"> <img alt=""  src="../../../static/imges/54537.png"></a>
                <a href="#" target="_blank"><img alt=""  src="../../../static/imges/45678678.png"></a>
                <a href="#" target="_blank"> <img alt=""  src="../../../static/imges/54375483543.png"></a>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="container">
        <div class="navbar-header">
            <a href="#" class="navbar-brand">
                <img src="../../../static/imges/logo.png" alt="Brand" class="../../../static/img-responsive">
            </a>
...
<div id="myCarousel" class="carousel slide">
    ...
    <div class="carousel-inner">
        <div class="item active">
            <img alt="First slide" src="../../../static/imges/547567.jpg">
        </div>
        <div class="item">
            <img alt="Second slide" src="../../../static/imges/547567.jpg">
        </div>
        <div class="item">
            <img alt="Third slide" src="../../../static/imges/547567.jpg">
        </div>
        <div class="item">
            <img alt="Third slide" src="../../../static/imges/547567.jpg">
        </div>
        <a data-slide="prev" href="#myCarousel" class="carousel-control left">
            <i class="icon-left"><img src="../../../static/imges/54354.png"></i>
        </a>
        <a data-slide="next" href="#myCarousel" class="carousel-control right">
            <i class="icon-right"><img src="../../../static/imges/4525424.png"></i>
        </a>
    </div>
</div>
...
<div class="main container">
    ...
    <div class="main-a row">
            ...
            <div class="row text-center">
                <ul class="list-unstyled">
                    <li class="col-xs-12 up-1">
                        <img alt="" src="../../../static/imges/45354312.png">
                    </li>
        ...
        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
            <div class="row text-center">
                <ul class="list-unstyled">
                    <li class="col-xs-12 up-1">
                        <img alt="" src="../../../static/imges/879789.png">
                    </li>
        ...
        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
            <div class="row text-center">
                <ul class="list-unstyled">
                    <li class="col-xs-12 up-1">
                        <img alt="" src="../../../static/imges/786453654365.png">
                    </li>
        ...
        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3 text-center">
            <p>
                <img src="../../../static/imges/453254312.png">${learner}<br>
                <span class="up-3">累计在线学习人数</span>
            </p>
            <p>
                <img src="../../../static/imges/453254312.png">${worker}<br>
    ...
    <div class="main-c row">
        ...
        <ul class="list-unstyled text-center">
            <li class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
                <div>
                    <img src="${url}${college0.headPicture}" width="50" height="50">
                    <span>技术顾问:${college0.name}</span>
            ...
            <li class="col-xs-12 col-sm-6 col-md-6 col-lg-3" >
                <div>
                    <img src="${url}${college1.headPicture}" width="50" height="50">
                    <span>技术顾问:${college1.name}</span>
                    <p class="text-left">百度技术总监：互联网基础服务领域，从事虚拟主机，云主机，域名。
                        曾任新网高级技术经理，负责技术研发，团队管理与建设。</p>
                </div>
            </li>
            <li class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
                <div>
                    <img src="${url}${college2.headPicture}" width="50" height="50">
                    <span>技术顾问:${college2.name}</span>
                    <p class="text-left">百度技术总监：互联网基础服务领域，从事虚拟主机，云主机，域名。
                        曾任新网高级技术经理，负责技术研发，团队管理与建设。</p>
                </div>
            </li>
            <li class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
                <div>
                    <img src="${url}${college3.headPicture}" width="50" height="50">
                    <span>技术顾问:${college3.name}</span>
                    <p class="text-left">百度技术总监：互联网基础服务领域，从事虚拟主机，云主机，域名。
                        曾任新网高级技术经理，负责技术研发，团队管理与建设。</p>
                </div>
            </li>
    ...
    <div class="row main-bottom">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <ul class="logo">
                <li>
                    <a href=""><img src="../../../static/imges/123132.png"></a>
                </li>
                <li>
                    <a href=""> <img src="../../../static/imges/1549865.png"></a>
                </li>
                <li>
                    <a href=""> <img src="../../../static/imges/785345.png"></a>
                </li>
                <li>
                    <a href=""> <img src="../../../static/imges/1471.png"></a>
                </li>
                <li>
                    <a href="">  <img src="../../../static/imges/7861.png"></a>
                </li>
            </ul>
        </div>
    </div>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-4 col-md-2 col-lg-2 up-3">
                <p>微信公众平台</p>
                <img alt="" src="../../../static/imges/2524.jpg">
            </div>
        </div>
    </div>
