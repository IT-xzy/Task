 ...
 */
package com.util.cloopen.rest.sdk;
...
import com.util.cloopen.rest.sdk.utils.EncryptUtil;
import com.util.cloopen.rest.sdk.utils.LoggerUtil;
...
public class CCPRestSmsSDK {
	...
	public HashMap<String, Object> sendTemplateSMS(String to, String templateId, String[] datas) {
		...
		com.util.cloopen.rest.sdk.utils.CcopHttpClient chc = new com.util.cloopen.rest.sdk.utils.CcopHttpClient();
	...
	private HttpRequestBase getHttpRequestBase(int get, String action) throws NoSuchAlgorithmException, UnsupportedEncodingException {
		String timestamp = com.util.cloopen.rest.sdk.utils.DateUtil.dateToStr(new Date(), com.util.cloopen.rest.sdk.utils.DateUtil.DATE_TIME_NO_SLASH);
