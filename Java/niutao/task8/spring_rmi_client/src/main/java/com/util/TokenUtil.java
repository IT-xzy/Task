...
public class TokenUtil {
    ...
    public static String ProduceToken(String id, String logtime) {
        //待加密内容
    ...
    public static String getTokenElementFromCookie(HttpServletRequest httpServletRequest,String cookieName) {
