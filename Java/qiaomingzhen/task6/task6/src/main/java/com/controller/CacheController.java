...
//    @Qualifier("userServiceRedisImpl")
     ...
     */
    @RequestMapping(value = "/people10", method = RequestMethod.POST)
    public ModelAndView addPeople10(ModelAndView modelAndView, People people, Result result) {
     ...
     */
    @RequestMapping(value = "/people10", method = RequestMethod.GET)
    public ModelAndView selectPeopleById10(ModelAndView modelAndView, long id,Result result) {
