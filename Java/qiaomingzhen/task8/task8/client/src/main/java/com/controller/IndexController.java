...
public class IndexController {
    ...
    public ModelAndView selectPeople(ModelAndView modelAndView, HttpServletRequest request, People people) {
    ...
    public ModelAndView selectCompany(ModelAndView modelAndView) {
        companyService=server.getCompanyService();
    ...
    public ModelAndView selectProfession(ModelAndView modelAndView) {
        ...
        profService=server.getProfService();
