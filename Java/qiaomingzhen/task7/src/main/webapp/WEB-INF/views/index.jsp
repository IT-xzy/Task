        ...
        <div class="container navigation">
            <div class="row">
                <div class="col-xs-12 col-md-12 col-lg-12">
                    <a href="https://bradmatt213.github.io/learngit/task8-2.html#" class="frontpage">关于</a>
                    <a href="https://bradmatt213.github.io/learngit/task8-3.html#">推荐</a>
                    <a href="https://bradmatt213.github.io/learngit/task8-3.html#">职业</a>
                    <a href="https://bradmatt213.github.io/learngit/task8.html">首页</a>
                </div>
            </div>
        </div>
    </div>
                    ...
                    <div class="col-md-6 col-lg-3 col-xs-12">
                        <div class="students">
                            ...
                            <div>
                                <p>${p.info}</p>
                                <p>
                                    <date:date value="${p.creatTime}"></date:date>
                                </p>
                            </div>
                        </div>
                    </div>
