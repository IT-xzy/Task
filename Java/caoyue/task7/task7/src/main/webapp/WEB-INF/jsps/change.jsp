...
<body>
    添加：
    <br><form action="${pageContext.request.contextPath}/student/${student.ID}" method="post">
            <input type="hidden" name="_method" value="PUT">
        姓名:<br><input type="text" name="name" value="${student.name}"><br>
        QQ:<br><input type="text" name="QQ" value="${student.QQ}"><br>
        线上学号:<br><input type="text" name="onlineNumber" value="${stdent.onlineNumber}"><br>
    ...
    <a href="${pageContext.request.contextPath }/user/student">返回</a>
</body>
</html>
