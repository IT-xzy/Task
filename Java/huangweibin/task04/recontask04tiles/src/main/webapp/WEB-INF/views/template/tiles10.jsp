...
<div id="myCarousel" class="carousel slide">
    ...
    <div class="carousel-inner">
        <div class="item active">
            <img height="" alt="First slide" src="${pageContext.request.contextPath}/imges/547567.jpg">
        </div>
        <div class="item">
...
<div class="main container">
    ...
    <div class="main-a row">
        ...
        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3 text-center">
            <p>
                <img src="${pageContext.request.contextPath}/imges/453254312.png">${querySum}<br>
                <span class="up-3">累计在线学习人数</span>
            </p>
            <p>
                <img src="${pageContext.request.contextPath}/imges/453254312.png">${queryWorkSum}<br>
    ...
    <div class="main-c row">
        ...
        <ul class="list-unstyled text-center">
            <c:forEach items="${queryFrontList}" var="queryFrontList" >

                <li class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
                    <div>
                        <img height="108" width="108" src="${queryFrontList.headportrait}">
                        <span>${queryFrontList.title}:${queryFrontList.name}</span>
                        <p class="text-left">${queryFrontList.introduction}</p>
                    </div>
                </li>
            </c:forEach>
        </ul>
