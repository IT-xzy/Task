        ...
        <c:forEach var="queryAllIntro" items="${queryAllIntro}">
            <div class="col-md-4 col-sm-6 col-xs-12 top-margin">
                <div
                        class="warp-border">
                    <div class="clearfix">
                        <div class="icon-people"><img img height="139" width="139" src="${queryAllIntro.picture}"></div>
                        <div class="text">
                    ...
                    <div class="warp-class2">
                        <div class="warp-class2-text">
                            <div class="iconfont text-padding">成长周期 <span class="iconfont-color"> ${queryAllIntro.growth}</span>
                            </div>
                        </div>
                        <div class="warp-class2-text">
                            <div class="iconfont text-padding text-border-left">稀缺程度 <span
                                    class="iconfont-color">${queryAllIntro.scarcity}</span>家公司需要
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="warp-class2">
                        <b class="text-b">有<span class="iconfont-color">${queryAllIntro.learningnum}</span>人正在学</b>
                    </div>
                    <div class="warp-class2">
