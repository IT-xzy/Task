...
<head>
    ...
    <link rel="stylesheet" href="/view/part4/css/three.css">
    <script src="/view/part4/js/jquery-3.2.1.min.js"></script>
    <link href="/view/part4/css/bootstrap.min.css"
          rel="stylesheet">
...
<div class="header-end">
    <a href="/a/task4/home" class="end-left">首页</a>>
...
<main>
    ...
    <div class="content">
        <div class="form">
            ...
            <div class="header">
                <img src="/view/part4/img/three/toux.png">
                <div>
                    <h4>Web前端开发师</h4>
                ...
                <div class="list-top">
                    <div class="list-top-1">
                        <div class="list-top-1-left">
                            门槛
                            <img src="/view/part4/img/three/xx.png" width="10" height="10">
                        </div>
