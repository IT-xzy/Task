...
<head>
    ...
    <link rel="stylesheet" href="/view/part4/css/home.css">
    <script src="/view/part4/js/jquery-3.2.1.min.js"></script>
    <link href="/view/part4/css/bootstrap.min.css" rel="stylesheet">
    <script src="/view/part4/js/bootstrap.min.js"></script>
</head>
...
<div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
        ...
        <div class="item active">
            <img src="/view/part4/img/home/banner.png">
        </div>
...
<div class="container ">
    ...
    <div class="row features">
        ...
        <div class="col-xs-3 main-media">
            <div class="main-one">
                <img src="/view/part4/img/home/main-one.png" height="50" width="35">
                <p class="topic">高效</p>
            </div>
        ...
        <div class="col-xs-3 main-media">
            <div class="main-two">
                <img src="/view/part4/img/home/main-two.png" height="50" width="60">
                <p class="topic">规范</p>
            </div>
        ...
        <div class="col-xs-3 main-media">
            <div class="main-three">
                <img src="/view/part4/img/home/main-three.png" height="50" width="50">
                <p class="topic">人脉</p>
            </div>
        ...
        <div class="col-xs-3 main-two-end main-media">
            <div class="main-fire">
                <img src="/view/part4/img/home/main-fire.png" height="13">${countStudent}
            </div>
            <div class="tip-end"><a href="/a/u/task2/student/list">累计在线学习人数</a></div>
            <div class="main-fire-bottom">
                <img src="/view/part4/img/home/main-fire.png" height="13">${countGraduate}
            </div>
...
<div class="container">
    ...
    <div class="row row-1">
        ...
        <div class="col-xs-3 student-1">
            <img src="/view/part4/img/home/${list.get(0).avatar}" alt="不高兴一号">
            <b>${list.get(0).name}</b>
            <p>${list.get(0).message}</p>
        </div>
        <div class="col-xs-3 student-2">
            <img src="/view/part4/img/home/${list.get(1).avatar}" alt="不高兴一号">
            <b>${list.get(1).name}</b>
            <p>${list.get(1).message}</p>
        </div>
        <div class="col-xs-3 student-3">
            <img src="/view/part4/img/home/${list.get(2).avatar}" alt="不高兴一号">
            <b>${list.get(2).name}</b>
            <p>${list.get(2).message}</p>
        </div>
        <div class="col-xs-3 student-4">
            <img src="/view/part4/img/home/${list.get(3).avatar}" alt="不高兴一号">
            <b>${list.get(3).name}</b>
