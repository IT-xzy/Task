...
public class EmailUtil {
    private static String regionId = "xxxxxxx";
    private static String accessKeyId = "xxxxxxx";
    private static String secret = "xxxxxxxxx";
    private static IClientProfile profile = DefaultProfile.getProfile(regionId, accessKeyId, secret);
    //激活邮件的有效时间，单位分钟
