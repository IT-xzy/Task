...
public class SMSUtil {
    ...
    private static final String product = "xxxxxxxxxxx";
    //产品域名,开发者无需替换
    private static final String domain = "xxxxxxxxx";
    //短信签名，需要自己申请过审
    private static final String signName = "xxxxxxx";
    //短信模板，需要自己申请过审
    private static final String templateCode = "xxxxxxxx";
