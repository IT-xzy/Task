...
public class DateUtil {
    ...
    public static String longToString(long currentTime, String formatType) throws UnavailableException {
        // long类型转成Date类型
        Date date = null;
        try {
    ...
    public static long stringToLong(String strTime, String formatType) throws UnavailableException {
        // String类型转成date类型
        Date date = null;
        try {
