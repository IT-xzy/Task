        ...
        <div class="container navigation">
            <div class="row">
                <div class="col-xs-12 col-md-12 col-lg-12">
                    <a href="./WEB-INF/jsps/task8-2.jsp#" class="frontpage">关于</a>
                    <a href="WEB-INF/jsps/task8-3.jsp#">推荐</a>
                    <a href="WEB-INF/jsps/task8-3.jsp">职业</a>
                    <a href="WEB-INF/jsps/task8.jsp">首页</a>
                </div>
            </div>
        </div>
    </div>
