...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <form action="${pageContext.request.contextPath}/u/loginByEmailSubmit" method="post">
                <div class="form-group">
                    <label for="email">邮箱</label> &nbsp;&nbsp;<span id="email-tip"></span>
                    <input type="tel" name="email" id="email" class="form-control" placeholder="请输入邮箱号" required>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <a class="btn btn-success" href="${pageContext.request.contextPath}/u/loginByPhone" role="button">使用手机登录</a>
                </div>
            </form>
        </div>
        <div class="col-md-4"></div>
