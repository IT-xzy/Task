...
public class passwordMD5 {
    ...
    public static void main(String[] args) {
        String password = passwordMD5.createPassword("123456");
        System.out.println("对123456用MD5加密后：" + password);
        String inputstr = "1234";
        System.out.println("1234与密码相同？" + passwordMD5.authenticatePassword(password, inputstr));
        inputstr = "123456";
        System.out.println("123456与密码相同？" + passwordMD5.authenticatePassword(password, inputstr));
    }
}
