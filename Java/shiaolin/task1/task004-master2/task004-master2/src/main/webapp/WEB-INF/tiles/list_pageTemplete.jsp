        ...
        <div class="container">
            ...
            <div id="example-navbar-collapse" class=" collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    <a href="${pageContext.request.contextPath}/u/index">
                        <li>首 页</li>
                    </a>
                    <a href="${pageContext.request.contextPath}/joblist">
                        <li class="border">职 业</li>
                    </a>
                    <a href="${pageContext.request.contextPath}/cooperate">
                        <li>推 荐</li>
                    </a>
                    <a href="">
                        <li>关 于</li>
        ...
        <c:forEach items="${jobList}" var="info">
            <div class="col-md-4 col-sm-6 col-xs-12 top-margin">
                ...
                <div class="warp-border">
                    <div class="clearfix">
                        <div class="icon-people"><img src="${pageContext.request.contextPath}/static/imges/687.png">
                        </div>
                        <div class="text">
                    ...
                    <div class="warp-class2">
                        <div class="warp-class2-text">
                            <div class="iconfont text-padding">门槛 <img
                                    src="${pageContext.request.contextPath}/static/imges/xx.png"></div>
                        </div>
                        <div class="warp-class2-text">
                            <div class="iconfont text-padding text-border-left">难易程度 <c:forEach begin="1"
                                                                                                end="${info.threshold}"
                                                                                                step="1"><img
                                    src="${pageContext.request.contextPath}/static//imges/xx.png"></c:forEach></div>
                        </div>
                    </div>
                    <div class="warp-class2">
                        <div class="warp-class2-text">
                            <div class="iconfont text-padding">成长周期 <span
                                    class="iconfont-color">${info.conpanyNumber}</span>年
                            </div>
                        </div>
                        <div class="warp-class2-text">
                            <div class="iconfont text-padding text-border-left">稀缺程度 <span
                                    class="iconfont-color">${info.rarity}</span>家公司需要
                            </div>
                        </div>
                    </div>
