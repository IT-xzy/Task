            ...
            <div class="col-md-6 main-r">
                <div class="mr-in">
                    <div style="text-align: center" class="main-rt">
                     ...
                     <p style="color: #000000;font-size: 20px;" > | 账户登录 | </p>
                    </div>
                    <div class="main-rb">
                        <form action="${pageContext.request.contextPath}/login/logining" method="post">
                            <table>
                                <tr>
                                ...
                                <tr>
                                    <td colspan="2" style="color: #ff5050;font-size: 14px" >
                                         what???忘记密码了??
                                        <a href="${pageContext.request.contextPath}/login/pas" />点点点我</td>
                                </tr>
                                <tr>
                                    <td colspan="2" style="color: #3232ff;font-size: 14px" >
                                        what???账户名也忘记??
                                        <a href="${pageContext.request.contextPath}/login/reg" />点点点我</td>
                                </tr>
                            </table>
                        </form>
                    </div>
