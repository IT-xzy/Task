                        ...
                        <form  method="post">
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td><input type="text" name="loginName" value="${login.loginName}"></td>
                                </tr>
                                <tr>
                                    <td style="color: #ff5c00;font-size: 20px;">头像:</td>

                                    <td><input type="text" name="loginPicture" value="${login.loginPicture}"></td>
                                </tr>
                                <tr>
                                    <td colspan="2" style="text-align: center;color: #FFFFFF">
                                        <button style="background-color: #ff5050;"
                                               type="submit" formaction="${pageContext.request.contextPath}/login/setting" >修改全部</button>
                                </tr>
                            </table>
                        </form>
                    </div>
