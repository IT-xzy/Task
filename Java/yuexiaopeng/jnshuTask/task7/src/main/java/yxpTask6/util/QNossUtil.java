...
import yxpTask6.pojo.ServicePojo.QNossAccount;
    ...
    * */
    public String uploadImage(String localFileName,String localFilePath)
    {
        ...
        try {
            ...
            System.out.println("文件上传后的外链地址为: "+fileUrl);
            return fileUrl;
        } catch (QiniuException ex) {
            Response r = ex.response;
            System.err.println(r.toString());
            System.out.println("上传的图片出错"+ex);
            try {
        ...
        {
            System.out.println("上传的图片出错"+e);
        }
        return fileUrl;
    }
    /*
    * 下载文件
    * @param 要下载的文件名称及保存到本地的名称
    * @Param localFilePath 本地的文件路径名称；
    * @return 正确为true
    * */
    public Boolean getFile(String onlineFileName,String localFilePath)
    {
        ...
        try{
            ...
            System.out.println("七牛云从网上下载出错"+e);
        }
        return boo;
    }
    /*
...
//        String bucket = qNossAccount.getBucketName();
        ...
        while (fileListIterator.hasNext()) {
            ...
            System.out.println("指定的bucket中的所有图片名称为 ："+listFileName);
        }
        return listFileName;
    }
}
