    ...
    <%--<div class="container">--%>
        ...
        <%--<div id="open-nav" class="navbar-collapse collapse" aria-expanded="false" style="height: 1px;">--%>
            <%--<ul class="nav navbar-nav navbar-right text-center list-inline">--%>
                <%--<li><a href="">首页</a></li>--%>
                <%--&lt;%&ndash;<li><a href="../t11/index.html">职业</a></li>&ndash;%&gt;--%>
                <%--<li><a href="">推荐</a></li>--%>
                <%--<li><a href="">关于</a></li>--%>
            <%--</ul>--%>
        <%--</div>--%>
...
<div class="main container">
    ...
    <div class="main-c row">
        ...
        <ul class="list-unstyled text-center">
            <c:forEach var="randomTalent" items="${randomTalent}">
                <li class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
                    <div>
                        <img src="${randomTalent.photo}">
                        <span>${randomTalent.job}:${randomTalent.name}</span>
                        <p class="text-left">${randomTalent.jobDescription}</p>
                    </div>
                </li>
            </c:forEach>
