...
<head>
    ...
    <form action="${pageContext.request.contextPath }/uploadForm" method="get">
        <input type="submit" value="完善资料"></form>
...
<div id="myCarousel" class="carousel slide">
    ...
    <div class="carousel-inner">
        ...
        <a data-slide="next" href="#myCarousel" class="carousel-control right">
            <i class="icon-right"><img src="${pageContext.request.contextPath }/static/imges/4525424.png.png"></i>
        </a>
    </div>
</div>
...
<div class="main container">
    ...
    <div class="main-c row">
        ...
        <ul class="list-unstyled text-center">
            <c:forEach var="randomTalent" items="${randomStudent}">
            <li class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
                <div>
                    <img src="${randomTalent.headPortrait}">
                    <span>${randomTalent.major}:${randomTalent.name}</span>
                    <p class="text-left">${randomTalent.intro}</p>
                </div>
            </li>
            </c:forEach>
            <%--<li class="col-xs-12 col-sm-6 col-md-6 col-lg-3">--%>
