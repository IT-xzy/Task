...
public class StatisticalTime {
    ...
    @After("execution(* com.student.controller.StudentController.delStudent(..))" +
            "||execution(* com.student.controller.StudentController.addStudent(..))" +
            "||execution(* com.student.controller.StudentController.updateStudent(..))")
    public void delMemcache() {
        try {
            memcachedClient.delete("studentList");
