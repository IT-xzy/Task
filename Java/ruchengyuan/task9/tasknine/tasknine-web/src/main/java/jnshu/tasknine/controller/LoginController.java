package jnshu.tasknine.controller;
...
public class LoginController {
    ...
    //上传图片
    @RequestMapping(value = "/a/u/student/pictrue", method = RequestMethod.GET)
    public String studentPicture(HttpServletRequest request, HttpServletResponse response, Model model) {

        return "task7/picture";
    }


    @RequestMapping(value = "/a/u/student/information", method = RequestMethod.GET)
    public String studentInformation(HttpServletRequest request, HttpServletResponse response, Model model) {

        return "task7/phoneAndEmail";
    }
