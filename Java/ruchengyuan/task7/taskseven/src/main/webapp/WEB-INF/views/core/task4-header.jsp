    ...
    <div class="row header-top">
        ...
        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 text-right">
            <div>
                ...
                <a href="/a/logout" style="color: #000;">退出登陆</a>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="container">
        ...
        <div id="open-nav" class="navbar-collapse collapse" aria-expanded="false" style="height: 1px;">
            <ul class="nav navbar-nav navbar-right text-center list-inline">
                ...
                <li><a href="/a/u/student/all">JSON</a></li>
                <li><a href="/a/u/student/table">表格</a></li>
                <li><a href="/a/u/student/pictrue">图片上传</a></li>
                <li><a href="/a/u/student/information">手机邮箱认证</a></li>
            </ul>
        </div>
