...
public class CookieUtils {
    ...
    public static int createCookie(HttpServletResponse response,String cookieName,String value,int time,String path){
    ...
    public static int destroyCookie(HttpServletRequest request, HttpServletResponse response, String cookieName) {
