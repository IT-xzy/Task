    ...
    <div class="main-c row">
        ...
        <ul class="list-unstyled text-center">
            ...
            <c:forEach items="${students}" var="stu">
                <%-- 判断是否为优秀学员 --%>
                <c:if test="${stu.ifExcellent}">
                    <li class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
                        <div>
                            <img src="${pageContext.request.contextPath }/static/images/${stu.picture}">
                            <span>${stu.profession}:${stu.name}</span><%-- 姓名 --%>
                            <p class="text-left">${stu.stuIntroduction}</p>
                        </div>
                    </li>
                </c:if>
            </c:forEach>
