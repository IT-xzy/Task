    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-3 text-center number">
                <%--<c:forEach begin="0" end="10" items="${professionList}" var="v" >--%>
                <%--<% out.print("");%>--%>
                <%--</c:forEach>--%>
                    <span class="gy"> 当前 在线人数 ： ${online_number}</span>
                <strong><img src="../images/logo04.png" alt="">${number}</strong>
...
<div class="person">
    <div class="container">
        <div class="row">
            ...
            <%--<div class="col-xs-12 col-sm-3 text-center person-border media-person">
                <img src="/images/portrait1.png" alt="">
                <strong>技术顾问：罗大佑</strong>
            ...
            <c:forEach items="${user}" var="u">
                <div class="col-xs-12 col-sm-3 text-center person-border media-person">
                    ...
                    <div>
                        ...
                        <img src="../images/${u.picture}">
                        <strong>${u.position}:${u.name}</strong>
                        <p>${u.introduction}</p>
