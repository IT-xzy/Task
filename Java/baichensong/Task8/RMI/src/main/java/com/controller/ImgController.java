...
public class ImgController {
   ...
   */
    private QiniuTool qiniuTool = (QiniuTool) applicationAll.application().getBean("sendImg");
    ...
    try {
        ...
        try {
            ...
            Response re = uploadManager.put(inputStream, Filename, qiniuTool.sendImg(),null,null);
