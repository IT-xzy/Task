...
import com.SendimagesTool.QiniuTool;
...
/**    private ApplicationContext applicationContext=new ClassPathXmlApplicationContext("applicationContext-client.xml");*/
    private UploadAili uploadAiliOSSAPI = (UploadAili) applicationAll.application().getBean("aliyunOss");
    ...
    // 七牛文件列表获取
        ...
        private boolean qiNiuFileToAliyunReal( String bucketname,String prefix, int limit, String delimiter, String prefixHttp) throws IOException {
            /*获取七牛OSS中文件列表·*/
            BucketManager.FileListIterator fileListIterator = new QiniuTool().getObjectList(bucketname,prefix, limit, delimiter);
