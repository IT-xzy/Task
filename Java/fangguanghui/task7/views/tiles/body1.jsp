...
<div class="main container">
    ...
    <div class="main-a row">
        ...
        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3 text-center">
            <p>
                <img src="${pageContext.request.contextPath}/static/imges/453254312.png">${study}<br>
                <span class="up-3">累计在线学习人数</span>
            </p>
            <p>
                <img src="${pageContext.request.contextPath}/static/imges/453254312.png">${working}<br>
    ...
    <div class="main-c row">
        ...
        <ul class="list-unstyled text-center">
            <c:forEach items="${outstanding}" var="stus">
            <li class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
                <div>
                    <img src="${pageContext.request.contextPath}/static/imges/242424.png">
                    <span>技术顾问:${stus.f_stuName}</span>
                    <p class="text-left">${stus.f_stuIntroduce}</p>
                </div>
            </li>
            </c:forEach>
        </ul>
