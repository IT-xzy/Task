...
<div class="main container">
    ...
    <div class="main-a row">
        ...
        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3 text-center">
            <p>
                <img src="/imges/453254312.png">${atnum}<br>
                <span class="up-3">累计在线学习人数</span>
            </p>
            <p>
                <img src="/imges/453254312.png">${upnum}<br>
    ...
    <div class="main-c row">
        ...
        <ul class="list-unstyled text-center">
            <c:forEach var="student" end="3"  items="${studentList}">
            <li class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
                <div>
                    <img src="${student.photo}">
                    <span>技术顾问:${student.name}</span>
                    <p class="text-left">${student.job}：${student.introduce}</p>
                </div>
            </li>
            </c:forEach>
        </ul>
