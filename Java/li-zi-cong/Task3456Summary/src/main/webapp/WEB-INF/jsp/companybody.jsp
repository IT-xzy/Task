...
<!--background-->
<div class="row">
    <div class="col-md-12 row3-2"><img class="background2" src="/png/背景图片2.png">
    </div>
</div>
<!--合作企业-->
<div class="row">
    <div class="col-md-10 col-md-offset-1 col-lg-8 col-lg-offset-2">
        ...
        <!--主要内容-->
        <div class="row">
            <div class="col-lg-3 col-md-3 col-sm-3 list-main">
            ...
            <div class="col-lg-9 col-md-9 col-sm-9 main">
                <div class="main-left-top">
                    <div style="float: left"><img class="tudouwang" src="/png/土豆网.png"></div>
