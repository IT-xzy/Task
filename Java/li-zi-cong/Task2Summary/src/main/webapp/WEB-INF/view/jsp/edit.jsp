...
<body>
<h1 style="text-align: center;background: gray">${studentInfo.id==null?'新增':'修改' }信息</h1><%--三目运算 --%>
<form action="/student" method="${studentInfo.id==null?"post":""}">
    <input type="hidden" 		name="flag"			value="${studentInfo.id==null?'':'put'}" >
