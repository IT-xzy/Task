...
import com.fangyuyang.service.strategy.Strategy;
...
public class TestController {
   ...
   String validateCode = "";
    ...
    public String index( Model model) throws IOException {
        ...
        logger.info("Learner数据库总数,{}",allId);
        int pictureId = randomLearner.nextInt(allId-3);
            model.addAttribute("hasLogin",loginModel);
            model.addAttribute("learner1", learnerService.findLearnerById(pictureId));
        model.addAttribute("learner2", learnerService.findLearnerById(pictureId+1));
        model.addAttribute("learner3", learnerService.findLearnerById(pictureId+2));
        model.addAttribute("learner4", learnerService.findLearnerById(pictureId+3));
    ...
    public String uploadPicture(Model model,Learner learner,@RequestParam("file") MultipartFile file) throws IOException {
     ...
     //       storageKey= storageService.qiniuPictureSend(inputStream);
