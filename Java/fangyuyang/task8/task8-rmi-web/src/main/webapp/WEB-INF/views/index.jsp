    ...
    <div class="main container">
        ...
        <div class="main-a row">
            ...
            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3 text-center">
                ...
                <p>
                <form action="${pageContext.request.contextPath}/mobileCheck" method="post">
        ...
        <div class="main-c row">
            <h3 class="text-center main-tab">优秀学员展示
                ...
                <ul class="list-unstyled text-center">
                    <li class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
                        <div>
                            <img src="${learner1.picture}"/>
                            <span>${learner1.name}</span>
                            <p class="text-left">${learner1.course}</p>
                        </div>
                    </li>
                </ul>
                ...
                <ul class="list-unstyled text-center">
                    <li class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
                        <div>
                            <img src="${learner2.picture}"/>
                            <span>${learner2.name}</span>
                            <p class="text-left">${learner2.course}</p>
                        </div>
                    </li>
                </ul>
                ...
                <ul class="list-unstyled text-center">
                    <li class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
                        <div>
                            <img src="${learner3.picture}"/>
                            <span>${learner3.name}</span>
                            <p class="text-left">${learner3.course}</p>
                        </div>
                    </li>
                </ul>
                ...
                <ul class="list-unstyled text-center">
                    <li class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
                        <div>
                            <img src="${learner4.picture}"/>
                            <span>${learner4.name}</span>
                            <p class="text-left">${learner4.course}</p>
                        </div>
                    </li>
                </ul>
            </h3>
