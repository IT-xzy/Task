package com.lihoo.jnshu.common.constant;

import com.lihoo.jnshu.common.util.commonUtil.DateUtils;
...
public class LoginStatus {
    private static Logger logger = LoggerFactory.getLogger(LoginStatus.class);
