...
import com.lihoo.ssm.RMI.StudentServiceFactory;
...
//    }
    ...
    @Autowired
    StudentServiceFactory studentServiceFactory;
    @Test
    public void addTest22() {
        StudentListService studentListService=StudentServiceFactory.getInstance();
        System.out.println(studentListService.selectByPrimaryKey(25L));
    ...
    @Test
    public void addTest33() {
        StudentListService studentListService1=
                (StudentListService)applicationContext.getBean("studentService1");
        StudentListService studentListService2=
                (StudentListService)applicationContext.getBean("studentService2");
        StudentServiceFactory studentServiceFactory=new StudentServiceFactory();

        studentServiceFactory.setStudentService1(studentListService1);
        studentServiceFactory.setStudentService2(studentListService2);
        StudentListService sss=StudentServiceFactory.getInstance();
        System.out.println(sss.selectByPrimaryKey(25l));
    }
