...
import com.lihoo.demo.utils.JdbcUtils;
...
//    }
    ...
    private  void add_foo_1() {
        ...
        try {
            ...
            conn = C3P0Utils.getConnection();
            String sql = "INSERT INTO addTest5(username,password,create_at,update_at) VALUES (?,?,?,?)";//sql语句中不加分号
...
//                pstmt.setInt(1,i);
                pstmt.setString(1,"王牌猎人"+(i+1));
                pstmt.setString(2,"我发现猎物了"+(i+1));
                pstmt.setInt(3,i+1);
