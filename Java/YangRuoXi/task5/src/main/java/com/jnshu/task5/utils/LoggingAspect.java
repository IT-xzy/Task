...
public class LoggingAspect {
    ...
    // 定义环绕通知的切点
    @Around(value = "execution(* com.jnshu.task5.controller.*.*(..)) || execution(* com.jnshu.task5.service.*.*(..)) ")
    ...
    @Around( value = "execution(* com.jnshu.task4.controller.*.*(..)) || execution(* com.jnshu.task4.service.*.*(..)) ")
