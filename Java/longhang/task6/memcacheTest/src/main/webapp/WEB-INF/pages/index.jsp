	...
	<div class="main container">
            ...
            <div class="main-a row">
                ...
                <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3 text-center">
                    <p>
                        <img src="../../t10/imges/453254312.png">${s}<br>
                        <span class="up-3">累计在线学习人数</span>
                    </p>
                    <p>
                        <img src="../../t10/imges/453254312.png">${ss}<br>
            ...
            <div class="main-c row">
                ...
                <ul class="list-unstyled text-center">
            <c:forEach items="${goodstuList}" var="goodstu">
                <form>
                    <li class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
                        <div>
                            <c:choose>
                                <c:when test="${goodstu.picture==1}">
                                    <img src="../../t10/imges/242424.png">
                                </c:when>
                                <c:when test="${goodstu.picture==2}">
                                    <img src="../../t10/imges/453254312.png">
                                </c:when>
                                <c:when test="${goodstu.picture==3}">
                                    <img src="../../t10/imges/452758278.png">
                                </c:when>
                            </c:choose>

                            <span>${goodstu.major}:${goodstu.name}</span>
                            <p class="text-left">${goodstu.wish}</p>
                        </div>
                    </li>
                    </form>
              </c:forEach>
