...
public class Student implements Serializable {
    ...
    public Student() {}
    public Student(Long id, String name, String qq, String wish, String major, Long create_at, Long update_at, String picture,boolean goodwork,boolean graduation,boolean goodstu,String email,String phone) {
        this.id = id;
        this.name = name;
        this.qq = qq;
        this.wish = wish;
