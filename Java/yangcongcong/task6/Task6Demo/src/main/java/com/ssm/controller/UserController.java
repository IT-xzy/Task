...
public class UserController {
    ...
    public String getAllUser(@RequestParam(value = "pn",defaultValue = "1")Integer pn, Model model) throws InterruptedException, MemcachedException, TimeoutException {
    ...
    @RequestMapping(value = "/nmusers", method = RequestMethod.GET)
    public String getAllNoMemecached(Model model) {
