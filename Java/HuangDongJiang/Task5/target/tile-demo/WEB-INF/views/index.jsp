...
<div class="container  hidden-xs">
    <div class="row header-top">
        ...
        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 text-right">
            <div>
                <a href="#" target="_blank"> <img alt=""  src="/html/imges/54537.png"></a>
                <a href="#" target="_blank"><img alt=""  src="/html/imges/45678678.png"></a>
                <a href="#" target="_blank"> <img alt=""  src="/html/imges/54375483543.png"></a>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="container">
        <div class="navbar-header">
            <a href="#" class="navbar-brand">
                <img src="/html/imges/logo.png" alt="Brand" class="img-responsive">
            </a>
        ...
        <div id="open-nav" class="navbar-collapse collapse" aria-expanded="false" style="height: 1px;">
            <ul class="nav navbar-nav navbar-right text-center list-inline">
                ...
                <li><a href="">推荐</a></li>
                <li><a href="">关于</a></li>
                <li style="color: red"><a href="${pageContext.request.contextPath}/login/login.jsp">请登录</a></li>
            </ul>
        </div>
    </div>
</nav>
...
<div id="myCarousel" class="carousel slide">
    ...
    <div class="carousel-inner">
        <div class="item active">
            <img alt="First slide" src="/html/imges/547567.jpg">
        </div>
        <div class="item">
            <img alt="Second slide" src="/html/imges/547567.jpg">
        </div>
        <div class="item">
            <img alt="Third slide" src="/html/imges/547567.jpg">
        </div>
        <div class="item">
            <img alt="Third slide" src="/html/imges/547567.jpg">
        </div>
        <a data-slide="prev" href="#myCarousel" class="carousel-control left">
            <i class="icon-left"><img src="/html/imges/54354.png"></i>
        </a>
        <a data-slide="next" href="#myCarousel" class="carousel-control right">
            <i class="icon-right"><img src="/html/imges/4525424.png"></i>
        </a>
    </div>
</div>
...
<div class="main container">
    ...
    <div class="main-a row">
            ...
            <div class="row text-center">
                <ul class="list-unstyled">
                    <li class="col-xs-12 up-1">
                        <img alt="" src="/html/imges/45354312.png">
                    </li>
        ...
        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
            <div class="row text-center">
                <ul class="list-unstyled">
                    <li class="col-xs-12 up-1">
                        <img alt="" src="/html/imges/879789.png">
                    </li>
        ...
        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
            <div class="row text-center">
                <ul class="list-unstyled">
                    <li class="col-xs-12 up-1">
                        <img alt="" src="/html/imges/786453654365.png">
                    </li>
        ...
        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3 text-center">
            <p>
                <img src="/html/imges/453254312.png">${learningStudentCount}<br>
                <span class="up-3">累计在线学习人数</span>
            </p>
            <p>
                <img src="/html/imges/453254312.png">${workingStudentCount}<br>
    ...
    <div class="main-c row">
        ...
        <ul class="list-unstyled text-center">
            ...
            <c:forEach items="${listStudentStatus}" var="student">
                <li class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
                    <div>
                        <img src=${student.picture} width="200" height="200">
                        <span>${student.career}</span>
                        <p class="text-left">${student.career_description}</p>
                    </div>
                </li>
            </c:forEach>
        </ul>
    ...
    <div class="row main-bottom">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <ul class="logo">
                <li>
                    <a href=""><img src="/html/imges/123132.png"></a>
                </li>
                <li>
                    <a href=""> <img src="/html/imges/1549865.png"></a>
                </li>
                <li>
                    <a href=""> <img src="/html/imges/785345.png"></a>
                </li>
                <li>
                    <a href=""> <img src="/html/imges/1471.png"></a>
                </li>
                <li>
                    <a href="">  <img src="/html/imges/7861.png"></a>
                </li>
            </ul>
        </div>
    </div>
