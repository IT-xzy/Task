                    ...
                    <div class="warp-border">
                        ...
                        <div class="warp-class2">
                            <div class="warp-class2-text">
                                <div class="iconfont text-padding">门槛<c:forEach begin="0" end="${career.threshold}"><img src="${pageContext.request.contextPath}/images/xx.png"></c:forEach> </div>
                            </div>
                            <div class="warp-class2-text">
                                <div class="iconfont text-padding text-border-left">难易程度<c:forEach begin="0" end="${career.diffcult}"><img src="${pageContext.request.contextPath}/images/xx.png"></c:forEach> </div>
                            </div>
                        </div>
                        <div class="warp-class2">
                            <div class="warp-class2-text">
