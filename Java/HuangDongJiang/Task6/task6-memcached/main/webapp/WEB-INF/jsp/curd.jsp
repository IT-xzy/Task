...
<body>
<h2>添加学生信息</h2>
<form action="student" method="post" id="studentForm1" >
    <div>
...
<h2>删除学生信息</h2>
<form action="student" method="post" id="studentForm2" >
...
<h2>更新学生信息</h2>
<form action="/student/infomation" method="post" id="studentForm3" >
...
<h2>查找学生信息(测试json)</h2>
<form action="student/id" method="GET" id="studentForm4">
    <div>
...
<h2>查找学生信息(测试jsp)</h2>
<form action="jsp/student/id" method="GET" >
    <div>
        <input type="text" name="id" class="id" placeholder="要查找学生的id" />
    </div>
    <button type="submit">查找学生信息</button>
</form>
<h2>查找所有学生信息</h2>
<form action="allStudent" method="GET" id="studentForm5">
