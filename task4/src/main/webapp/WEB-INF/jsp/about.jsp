...
<header>
    ...
    <a href="/u/job" style="color:blue;float: right" ><%=request.getSession().getAttribute("name")%>  </a><%}else{%>
...
<%--<main>--%>
    <%--<span>我们相信人人都能成为一个合格的IT工程师，“找个师兄 带你入门”是最快最高效的学习方式，让初学者不再迷茫，掌控自己学习的节奏，更快成就自己。</span>--%>
<%--</main>--%>
