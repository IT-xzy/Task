...
var imgTwo4 = document.getElementsByClassName(" img-two4");
var orange = document.getElementsByClassName("two-orange");
var main = document.getElementById("main");
var kill = document.getElementById("kill");
var twoSpeak = document.getElementById("two-speak");
var footerDeter = document.getElementById("footerDeter");

footerDeter.disabled = true;
...
function vote() {
    if (confirm("是否确定选择")) {
        ...
        if (state === null) {
            ...
            for (var i = 0; i < result.length; i++){
                imgTwo4[i].disabled = true;
            }
            alert("请点击确定继续流程");
            // location.href = "jstask3-2.html";
        }
        footerDeter.disabled = false;
    }
